...
var controls = [ "ACC01", "ACC02", "ACC03", "ACC04", "ACC05", "ACC06", "ACC07", "ACC08", "ACC09", "ACC10", "ACC11", "ACC12", "ACC13", "ACC14", "ACC15", "ACC16", "ACC17", "ACC27", "ACC28", "ACC29", "ACC30", "ACC31", "ACC33", "ACC35", "ACC36" ]

function init() {
}

function /*String*/ getKey(/*Dataset*/ record) {
	return ''+record.accountuid.get();
}
