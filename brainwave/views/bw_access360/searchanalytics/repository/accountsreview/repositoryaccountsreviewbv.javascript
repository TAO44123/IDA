...
function standardReviewerFinding(/*DataSet*/ record) {
	...
	// precomputing phase: get business owner infos
	...
	// STEP 2: Tech. accounts & orphan accounts are reviewed by app owner
	if(!isUserAccount) {
	...
	// STEP 7: All accounts are reviewed by the default reviewer
