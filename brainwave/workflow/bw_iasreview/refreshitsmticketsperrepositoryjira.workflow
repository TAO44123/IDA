...
<Workflow version="1.0">
	<Definition name="bwr_refreshitsmticketsperrepositoryjira" statictitle="refreshitsmticketsperrepository" scriptfile="workflow/bw_iasreview/refreshitsmticketsperrepositoryjira.javascript" displayname="refreshitsmticketsperrepository" type="builtin-technical-workflow" technical="true">
