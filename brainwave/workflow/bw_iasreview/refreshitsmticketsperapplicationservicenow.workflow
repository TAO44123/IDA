...
<Workflow version="1.0">
	<Definition name="bwr_refreshitsmticketsperapplicationservicenow" statictitle="refreshitsmticketsperapplicationservicenow" scriptfile="workflow/bw_iasreview/refreshitsmticketsperapplicationservicenow.javascript" displayname="refreshitsmticketsperapplicationservicenow" type="builtin-technical-workflow" technical="true">
		<Component name="CSTART" type="startactivity" x="225" y="-106" w="200" h="114" title="Start" compact="true">
			...
			<Actions function="init">
				...
				<Action name="U1655368117141" action="executeview" viewname="bwiasr_pendingrightsperappli" append="false" attribute="remediationrecorduid">
					<ViewParam name="P16553681171410" param="application" paramvalue="{dataset.application.get()}"/>
		...
		<Component name="C1655368217153" type="callactivity" x="99" y="110" w="300" h="98" title="get latest tickets status">
			<Process workflowfile="/workflow/bw_servicenow/getservicenowtaskstatus.workflow">
				...
				<Input name="A1747041934291" variable="authentication_type" content="itsmauthenticationtype"/>
				<Input name="A1747041941095" variable="oauth_client_id" content="itsmclientid"/>
				<Input name="A1747041947233" variable="oauth_client_secret_password" content="itsmclientsecret"/>
				<Input name="A1747041958416" variable="oauth_grant_type" content="itsmtokengranttype"/>
				<Input name="A1747041969246" variable="oauth_refresh_token" content="itsmrefreshtoken"/>
				<Input name="A1747041978051" variable="oauth_expiration_date" content="itsmtokenexpirationdate"/>
				<Input name="A1747041984295" variable="oauth_expires_in" content="itsmtokenexpiresin"/>
				<Input name="A1747041989988" variable="oauth_scope" content="itsmscope"/>
			</Process>
		</Component>
		...
		<Component name="C1656084673431" type="variablechangeactivity" x="100" y="-19" w="300" h="98"/>
	...
	<Variables>
		...
		<Variable name="A1656603329946" variable="application" displayname="application" editortype="Ledger Application" type="String" multivalued="false" visibility="in" notstoredvariable="true"/>
		<Variable name="A1747041843893" variable="itsmauthenticationtype" displayname="itsmauthenticationtype" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1747041849239" variable="itsmtokengranttype" displayname="itsmtokengranttype" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1747041853627" variable="itsmclientid" displayname="itsmclientid" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1747041857967" variable="itsmclientsecret" displayname="itsmclientsecret" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1747041862521" variable="itsmrefreshtoken" displayname="itsmrefreshtoken" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1747041868439" variable="itsmtokenexpiresin" displayname="itsmtokenexpiresin" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1747041874402" variable="itsmtokenexpirationdate" displayname="itsmtokenexpirationdate" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1747041879037" variable="itsmscope" displayname="itsmscope" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
	</Variables>
</Workflow>
