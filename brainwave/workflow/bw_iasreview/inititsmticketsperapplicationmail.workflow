...
<Workflow version="1.0">
	<Definition name="bwr_inititsmticketsperapplicationmail" statictitle="inititsmticketsperapplication" scriptfile="workflow/bw_iasreview/inititsmticketsperapplicationmail.javascript" displayname="inititsmticketsperapplication" type="builtin-technical-workflow" technical="true">
		<Component name="CSTART" type="startactivity" x="508" y="-540" w="200" h="114" title="Start" compact="true" outexclusive="true">
			<Ticket create="true"/>
			<Actions function="init">
				...
				<Action name="U1656434949150" action="executeview" viewname="bwiasr_initrightsperapplibv" append="false" attribute="accountidentifier">
					...
					<ViewAttribute name="P1656434949150_1" attribute="accountidentifier" variable="accountidentifier"/>
					<ViewAttribute name="P1656434949150_2" attribute="accountlogin" variable="accountlogin"/>
					<ViewAttribute name="P1656434949150_3" attribute="accountusername" variable="accountusername"/>
					<ViewAttribute name="P1656434949150_4" attribute="applicationdisplayname" variable="applicationdisplayname"/>
					<ViewAttribute name="P1656434949150_5" attribute="applicationcode" variable="applicationcode"/>
					<ViewAttribute name="P1656434949150_6" attribute="repositorydisplayname" variable="repositorydisplayname"/>
					<ViewAttribute name="P1656434949150_7" attribute="remediationrecorduid" variable="remediationrecorduid"/>
					<ViewAttribute name="P1656434949150_8" attribute="reviewactiondate" variable="reviewactiondate"/>
					<ViewAttribute name="P1656434949150_9" attribute="reviewcomment" variable="reviewcomment"/>
					<ViewAttribute name="P1656434949150_10" attribute="reviewerfullname" variable="reviewerfullname"/>
					<ViewAttribute name="P1656434949150_11" attribute="reviewerhrcode" variable="reviewerhrcode"/>
					<ViewAttribute name="P1656434949150_12" attribute="reviewstatus" variable="reviewstatus"/>
					<ViewAttribute name="P1656434949150_13" attribute="permissioncode" variable="permissioncode"/>
					<ViewAttribute name="P1656434949150_14" attribute="perimeterdisplayname" variable="perimeterdisplayname"/>
					<ViewAttribute name="P1656434949150_15" attribute="permissiondisplayname" variable="permissiondisplayname"/>
					<ViewAttribute name="P1656434949150_16" attribute="perimetercode" variable="perimetercode"/>
					<ViewAttribute name="P1656434949150_17" attribute="applicationbwr_remediation_application_type" variable="remediationtype"/>
				</Action>
				...
				<Action name="U1756203765652" action="update" attribute="changetitle" newvalue="Changes are requested for server {dataset.applicationdisplayname.get(0)}" condition="dataset.applicationtype.get().equals(&apos;Server&apos;)"/>
			</Actions>
		</Component>
		<Component name="CEND" type="endactivity" x="508" y="458" w="200" h="98" title="End" compact="true" inexclusive="true"/>
		<Component name="C1655285385163" type="updateticketreviewactivity" x="382" y="130" w="300" h="98" title="update ticket number &amp; review status">
		...
		<Component name="C1662538654815_1" type="startsubactivity" x="508" y="-428" w="300" h="50" compact="true" title="Subprocess start">
			<Iteration listvariable="accountidentifier">
				...
				<Variable name="A1662619907378" variable="applicationcode"/>
				<Variable name="A1662619914976" variable="applicationdisplayname"/>
				<Variable name="A1662619921990" variable="permissioncode"/>
				<Variable name="A1662619928765" variable="permissiondisplayname"/>
				<Variable name="A1662619934333" variable="permissioncode"/>
				<Variable name="A1662619937891" variable="perimeterdisplayname"/>
			</Iteration>
		</Component>
		<Component name="C1662481348535_1" type="mailnotificationactivity" x="382" y="-318" w="300" h="98" title="Send notifications" outexclusive="true">
			<Notification name="mail" mail="A1756204315326" ignoreerror="true"/>
			<Output name="output" okmailvariable="emailsent"/>
		</Component>
		<Component name="C1655285039929_3" type="variablechangeactivity" x="382" y="-167" w="300" h="98" title="prepare ticket update" inexclusive="true">
			<Actions>
				<Action name="U1655365636898" action="update" attribute="currentdatetime" newvalue="{new Date().toLDAPString()}"/>
			</Actions>
		</Component>
		<Link name="L1662538671540_1" source="C1662538654815_1" target="C1662481348535_1" priority="1"/>
		<Link name="L1662483685750_1" source="C1662481348535_1" target="C1655285039929_3" priority="1" expression="dataset.emailsent.length&gt;0" labelcustom="true" label="email sent"/>
		<Link name="L1662619417858" source="CSTART" target="C1662538654815_1" priority="1"/>
		<Component name="C1662538677679_1" type="endsubactivity" x="508" y="316" w="300" h="50" compact="true" title="Subprocess end" inexclusive="true"/>
		<Link name="L1662620000717" source="C1662538677679_1" target="CEND" priority="1"/>
		<Link name="L1662620002593" source="C1655285039929_3" target="C1655285039929_2" priority="1"/>
		<Link name="L1662622977115" source="C1662481348535_1" target="C1662538677679_1" priority="2"/>
	</Definition>
	<Variables>
		...
		<Variable name="A1756203721076" variable="applicationtype" displayname="applicationtype" editortype="Default" type="String" multivalued="false" visibility="in" notstoredvariable="true"/>
	</Variables>
	<Mails>
		<Mail name="A1662620745538" displayname="remediation mail" description="remediation mail" notifyrule="bwiasr_right_remediation" tolist="sendto_id">
			...
			<Param name="applicationcode" variable="applicationcode"/>
			<Param name="applicationdisplayname" variable="applicationdisplayname"/>
			<Param name="permissioncode" variable="permissioncode"/>
			<Param name="permissiondisplayname" variable="permissiondisplayname"/>
			<Param name="perimetercode" variable="perimetercode"/>
			<Param name="perimeterdisplayname" variable="perimeterdisplayname"/>
			<Param name="sendto_mail" variable="sendto_mail"/>
			<Param name="sendto_name" variable="sendto_name"/>
		</Mail>
		<Mail name="A1756204165135" displayname="server remediation mail" description="server remediation mail" notifyrule="bwiasr_server_remediation" tolist="sendto_id">
			<Param name="accountidentifier" variable="accountidentifier"/>
			<Param name="accountlogin" variable="accountlogin"/>
			<Param name="accountusername" variable="accountusername"/>
			<Param name="repositorydisplayname" variable="repositorydisplayname"/>
			...
			<Param name="reviewerfullname" variable="reviewerfullname"/>
			<Param name="reviewerhrcode" variable="reviewerhrcode"/>
			<Param name="servercode" variable="applicationcode"/>
			<Param name="serverdisplayname" variable="applicationdisplayname"/>
			<Param name="permissioncode" variable="permissioncode"/>
			<Param name="permissiondisplayname" variable="permissiondisplayname"/>
			<Param name="perimetercode" variable="perimetercode"/>
			<Param name="perimeterdisplayname" variable="perimeterdisplayname"/>
		...
		<PolicyMail name="A1756204315326" displayname="Remediation mail" description="Send the right remediation email depending on the application type : &#xA;&quot;Server&quot; or else">
			<ConditionalMail name="A1756204349461" mail="A1756204165135" expression="dataset.applicationtype.get().equals(&quot;Server&quot;)"/>
			<ConditionalMail name="A1756204387016" mail="A1662620745538" expression="!dataset.applicationtype.get().equals(&quot;Server&quot;)"/>
		</PolicyMail>
	</Mails>
</Workflow>
