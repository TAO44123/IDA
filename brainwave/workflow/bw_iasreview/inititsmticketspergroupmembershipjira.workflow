...
<Workflow version="1.0">
	<Definition name="bwr_inititsmticketspergroupmembershipjira" statictitle="inititsmticketspergroupmembership" scriptfile="workflow/bw_iasreview/inititsmticketspergroupmembershipjira.javascript" displayname="inititsmticketspergroupmembership" type="builtin-technical-workflow" technical="true">
		<Component name="CSTART" type="startactivity" x="203" y="-406" w="200" h="114" title="Start" compact="true" outexclusive="true">
			...
			<Actions function="createChangeInfos">
				...
				<Action name="U1655217131432" action="executeview" viewname="bwiasr_initgroupmembershipperrepobv" append="false" attribute="accountidentifier">
					...
					<ViewAttribute name="P1655217131432_13" attribute="repositorybwr_remediation_repository_type" variable="remediationtype"/>
					<ViewAttribute name="P1655217131432_14" attribute="grouprepositorydisplayname" variable="grouprepositorydisplayname"/>
					<ViewAttribute name="P1655217131432_15" attribute="repositorydisplayname" variable="repositorydisplayname"/>
				</Action>
		...
		<Link name="L1655224077815" source="C1663058747968" target="C1655285039929_7" priority="2"/>
		<Component name="C1655282499443" type="callactivity" x="77" y="-140" w="300" h="98" title="create ticket" outexclusive="true">
			<Process workflowfile="/workflow/bw_jira/createIssue.workflow">
				...
				<Output name="A1743105414536" variable="errorMessage" content="resultdescription"/>
			</Process>
		</Component>
		...
		<Component name="C1655285039929_2" type="variablechangeactivity" x="77" y="733" w="300" h="98" title="prepare tickets updates" inexclusive="true">
			<Actions>
		...
		<Component name="C1655285039929_7" type="variablechangeactivity" x="428" y="733" w="300" h="98" title="prepare tickets updates" inexclusive="true">
			<Actions>
				<Action name="U1655365636898" action="update" attribute="currentdatetime" newvalue="{new Date().toLDAPString()}"/>
		...
		<Component name="C1655285385163_2" type="updateticketreviewactivity" x="428" y="866" w="300" h="98" title="update ticket number &amp; review status">
			<UpdateTicketReview ticketreviewnumbervariable="remediationrecorduid">
				<Attribute name="status" attribute="ticketstatus"/>
				<Attribute name="custom2" attribute="ticketclosedstatus"/>
				<Attribute name="actiondate" attribute="currentdatetime"/>
		...
		<Link name="L1743105123816_1" source="C1655285039929_7" target="C1655285385163_2" priority="1"/>
		<Link name="L1743105332374" source="C1655285385163_2" target="CEND" priority="1"/>
	</Definition>
	<Variables>
		...
		<Variable name="A1743105352407" variable="resultdescription" displayname="resultdescription" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1743105881172" variable="retrymode" displayname="retrymode" editortype="Default" type="Boolean" multivalued="false" visibility="in" notstoredvariable="true"/>
		<Variable name="A1755614001331" variable="repositorydisplayname" displayname="repositorydisplayname" editortype="Default" type="String" multivalued="true" visibility="local" notstoredvariable="true"/>
	</Variables>
</Workflow>
