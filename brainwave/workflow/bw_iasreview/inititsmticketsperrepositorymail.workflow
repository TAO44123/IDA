...
<Workflow version="1.0">
	<Definition name="bwr_inititsmticketsperrepositorymail" statictitle="inititsmticketsperrepository" scriptfile="workflow/bw_iasreview/inititsmticketsperrepositorymail.javascript" displayname="inititsmticketsperrepository" type="builtin-technical-workflow" technical="true">
		<Component name="CSTART" type="startactivity" x="244" y="66" w="200" h="114" title="Start" compact="true" outexclusive="true">
			...
			<Actions function="init">
				...
				<Action name="U1655217131432" action="executeview" viewname="bwiasr_initaccountsperrepobv" append="false" attribute="accountidentifier">
					...
					<ViewAttribute name="P1655217131432_4" attribute="repositorydisplayname" variable="repositorydisplayname"/>
					...
					<ViewAttribute name="P1655217131432_11" attribute="repositorybwr_remediation_repository_type" variable="remediationtype"/>
				</Action>
	...
	<Mails>
		<Mail name="A1662483050908" displayname="remediation mail" description="remediation mail" notifyrule="bwiasr_account_remediation" tolist="sendto_id">
