...
<Workflow version="1.0">
	<Definition name="bwr_inititsmticketsperapplicationservicenow" statictitle="inititsmticketsperapplication" scriptfile="workflow/bw_iasreview/inititsmticketsperapplicationservicenow.javascript" displayname="inititsmticketsperapplication" type="builtin-technical-workflow" technical="true">
		<Component name="CSTART" type="startactivity" x="495" y="-540" w="200" h="114" title="Start" compact="true" outexclusive="true">
			...
			<Actions function="createChangeInfos">
				...
				<Action name="U1656434949150" action="executeview" viewname="bwiasr_initrightsperapplibv" append="false" attribute="accountidentifier">
					<ViewParam name="P16564349491500" param="application" paramvalue="{dataset.application.get()}"/>
					<ViewParam name="P16564349491501" param="retrymode" paramvalue="{dataset.retrymode.get()}"/>
					<ViewAttribute name="P1656434949150_2" attribute="accountidentifier" variable="accountidentifier"/>
					<ViewAttribute name="P1656434949150_3" attribute="accountlogin" variable="accountlogin"/>
					<ViewAttribute name="P1656434949150_4" attribute="accountusername" variable="accountusername"/>
					<ViewAttribute name="P1656434949150_5" attribute="applicationdisplayname" variable="applicationdisplayname"/>
					<ViewAttribute name="P1656434949150_6" attribute="applicationcode" variable="applicationcode"/>
					<ViewAttribute name="P1656434949150_7" attribute="repositorydisplayname" variable="repositorydisplayname"/>
					<ViewAttribute name="P1656434949150_8" attribute="remediationrecorduid" variable="remediationrecorduid"/>
					<ViewAttribute name="P1656434949150_9" attribute="reviewactiondate" variable="reviewactiondate"/>
					<ViewAttribute name="P1656434949150_10" attribute="reviewcomment" variable="reviewcomment"/>
					<ViewAttribute name="P1656434949150_11" attribute="reviewerfullname" variable="reviewerfullname"/>
					<ViewAttribute name="P1656434949150_12" attribute="reviewerhrcode" variable="reviewerhrcode"/>
					<ViewAttribute name="P1656434949150_13" attribute="reviewstatus" variable="reviewstatus"/>
					<ViewAttribute name="P1656434949150_14" attribute="permissioncode" variable="permissioncode"/>
					<ViewAttribute name="P1656434949150_15" attribute="perimeterdisplayname" variable="perimeterdisplayname"/>
					<ViewAttribute name="P1656434949150_16" attribute="permissiondisplayname" variable="permissiondisplayname"/>
					<ViewAttribute name="P1656434949150_17" attribute="perimetercode" variable="perimetercode"/>
					<ViewAttribute name="P1656434949150_18" attribute="applicationbwr_remediation_application_type" variable="remediationtype"/>
				</Action>
				<Action name="U1655220598185" action="update" attribute="changetitle" newvalue="Changes are requested for application {dataset.applicationdisplayname.get(0)}"/>
				<Action name="U1756201827488" action="update" attribute="changetitle" newvalue="Changes are requested for server {dataset.applicationdisplayname.get(0)}" condition="dataset.applicationtype.get().equals(&apos;Server&apos;)"/>
			</Actions>
		</Component>
		...
		<Link name="L1655224077815" source="C1655282499443" target="C1655285039929_4" priority="2"/>
		<Component name="C1655282499443" type="callactivity" x="120" y="168" w="300" h="98" title="create incident" outexclusive="true">
			<Process workflowfile="/workflow/bw_servicenow/createservicenowincident.workflow">
				...
				<Output name="A1741613535020" variable="resultdescription" content="resultdescription"/>
			</Process>
		</Component>
		...
		<Component name="N1655284989441" type="note" x="1363" y="431" w="279" h="191" title="SERVICENOW INCIDENT STATUS&#xA;&#xA;1 New&#xA;2 In Progress&#xA;3 On Hold&#xA;4 On Hold&#xA;5 On Hold&#xA;6 Resolved&#xA;7 Closed&#xA;8 Canceled"/>
		...
		<Link name="L1655449556458" source="C1655449520979" target="C1657213098824_1" priority="1" expression="(dataset.equals(&apos;itsmtickettype&apos;, &apos;incident&apos;, false, true))" labelcustom="true" label="incident"/>
		...
		<Component name="C1655282499443_1" type="callactivity" x="633" y="168" w="300" h="98" title="create change request" outexclusive="true">
			<Process workflowfile="/workflow/bw_servicenow/createservicenowchangerequest.workflow">
				...
				<Input name="A1747043654457" variable="oauth_expires_in" content="itsmtokenexpiresin"/>
				<Input name="A1747043660049" variable="oauth_scope" content="itsmscope"/>
				<Output name="A1741617182324" variable="resultdescription" content="resultdescription"/>
			</Process>
		</Component>
		...
		<Component name="C1655285385163_1" type="updateticketreviewactivity" x="633" y="988" w="300" h="98" title="update ticket number &amp; review status">
			<UpdateTicketReview ticketreviewnumbervariable="remediationrecorduid">
				<Attribute name="custom5" attribute="ticketextref1"/>
				<Attribute name="custom6" attribute="ticketextref2"/>
				<Attribute name="custom7" attribute="ticketextrefinstance"/>
		...
		<Link name="L1656063810004" source="C1655282499443_1" target="C1655285039929_5" priority="2"/>
		<Link name="L1656063830435" source="C1655449520979" target="C1657213080222_1" priority="2" expression="(dataset.equals(&apos;itsmtickettype&apos;, &apos;changerequest&apos;, false, true))" labelcustom="true" label="change request"/>
		<Link name="L1656063975792" source="C1655449520979" target="CEND" priority="3"/>
		<Component name="N1656070964558" type="note" x="717" y="-516" w="300" h="345" title="SERVICE NOW&#xA;&#xA;url - string 4&#xA;tickettype - string5&#xA;login - string 6&#xA;password - string 7&#xA;call userid - string 8&#xA;assignment group name - string 9&#xA;authentication type - string 11&#xA;token grant type - string 12&#xA;client ID - string13&#xA;client secret - string 14&#xA;refresh token - string 15&#xA;token expires in - string 16&#xA;token expiration date - string 17&#xA;scope - string 18"/>
		<Component name="N1656078420247" type="note" x="1372" y="227" w="300" h="185" title="SERVICENOW CHANGE REQUEST STATUS&#xA;&#xA;-5 New&#xA;-4 Assess&#xA;-3 Authorize&#xA;-2 Scheduled&#xA;-1 Implement&#xA;0 Review&#xA;3 Closed&#xA;4 Canceled"/>
		...
		<Component name="C1657213098824_1" type="variablechangeactivity" x="121" y="62" w="300" h="98" title="attachment name">
			<Actions>
				<Action name="U1657213197377" action="update" attribute="changefilename" newvalue="incidents.csv"/>
			</Actions>
		</Component>
		<Component name="C1657213080222_1" type="variablechangeactivity" x="641" y="65" w="300" h="98" title="attachment name">
			<Actions>
				<Action name="U1657213215165" action="update" attribute="changefilename" newvalue="changerequests.csv"/>
			</Actions>
		</Component>
		<Link name="L1657263131113" source="C1657213080222_1" target="C1655282499443_1" priority="1"/>
		<Link name="L1657263132393" source="C1657213098824_1" target="C1655282499443" priority="1"/>
		<Component name="C1655285385163_2" type="updateticketreviewactivity" x="-206" y="986" w="300" h="98" title="update ticket number &amp; review status">
			<UpdateTicketReview ticketreviewnumbervariable="remediationrecorduid">
				<Attribute name="status" attribute="ticketstatus"/>
				<Attribute name="actiondate" attribute="currentdatetime"/>
				<Attribute name="custom3" attribute="remediationtype"/>
		...
		<Link name="L1741612617553" source="C1655285385163_2" target="CEND" priority="1"/>
		<Component name="C1655285385163_3" type="updateticketreviewactivity" x="964" y="988" w="300" h="98" title="update ticket number &amp; review status">
			<UpdateTicketReview ticketreviewnumbervariable="remediationrecorduid">
				<Attribute name="status" attribute="ticketstatus"/>
				<Attribute name="actiondate" attribute="currentdatetime"/>
				<Attribute name="custom3" attribute="remediationtype"/>
		...
		<Link name="L1741612658506" source="C1655285385163_3" target="CEND" priority="1"/>
		<Component name="C1655285039929_4" type="variablechangeactivity" x="-206" y="842" w="300" h="98" title="prepare tickets updates" inexclusive="true">
			<Actions>
				<Action name="U1655365636898" action="update" attribute="currentdatetime" newvalue="{new Date().toLDAPString()}"/>
				<Action name="U1741617078445" action="update" attribute="ticketstatus" newvalue="error"/>
				<Action name="U1741635140854" action="update" attribute="ticketclosedstatus" newvalue="3"/>
			</Actions>
		</Component>
		<Link name="L1741613282412" source="C1655285039929_4" target="C1655285385163_2" priority="1"/>
		<Component name="C1655285039929_5" type="variablechangeactivity" x="964" y="848" w="300" h="98" title="prepare tickets updates" inexclusive="true">
			<Actions>
				<Action name="U1655365636898" action="update" attribute="currentdatetime" newvalue="{new Date().toLDAPString()}"/>
				<Action name="U1741617078445" action="update" attribute="ticketstatus" newvalue="error"/>
				<Action name="U1741635154249" action="update" attribute="ticketclosedstatus" newvalue="3"/>
			</Actions>
		</Component>
		<Link name="L1741617122027" source="C1655285039929_5" target="C1655285385163_3" priority="1"/>
	</Definition>
	<Variables>
		...
		<Variable name="A1656434354080" variable="application" displayname="application" editortype="Ledger Application" type="String" multivalued="false" visibility="in" notstoredvariable="true"/>
		<Variable name="A16564349491503" variable="applicationdisplayname" displayname="applicationdisplayname" multivalued="true" visibility="local" type="String" editortype="Default"/>
		<Variable name="A16564349491504" variable="applicationcode" displayname="applicationcode" multivalued="true" visibility="local" type="String" editortype="Default"/>
		<Variable name="A165643494915012" variable="permissioncode" displayname="permissioncode" multivalued="true" visibility="local" type="String" editortype="Default"/>
		<Variable name="A165643494915013" variable="perimeterdisplayname" displayname="perimeterdisplayname" multivalued="true" visibility="local" type="String" editortype="Default"/>
		<Variable name="A165643494915014" variable="permissiondisplayname" displayname="permissiondisplayname" multivalued="true" visibility="local" type="String" editortype="Default"/>
		<Variable name="A165643494915015" variable="perimetercode" displayname="perimetercode" multivalued="true" visibility="local" type="String" editortype="Default"/>
		<Variable name="A165643494915016" variable="remediationtype" displayname="remediationtype" multivalued="true" visibility="local" type="String" editortype="Default"/>
		<Variable name="A1746457879235" variable="itsmauthenticationtype" displayname="itsmauthenticationtype" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1746457897077" variable="itsmtokengranttype" displayname="itsmtokengranttype" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1746457910288" variable="itsmclientid" displayname="itsmclientid" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1746457917199" variable="itsmclientsecret" displayname="itsmclientsecret" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1746457925505" variable="itsmrefreshtoken" displayname="itsmrefreshtoken" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1746457936416" variable="itsmtokenexpiresin" displayname="itsmtokenexpiresin" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1746457948016" variable="itsmtokenexpirationdate" displayname="itsmtokenexpirationdate" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1747044146489" variable="itsmscope" displayname="itsmscope" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1741613505604" variable="resultdescription" displayname="resultdescription" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1741807296357" variable="emptycomment" displayname="emptycomment" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1741810402615" variable="retrymode" displayname="retrymode" editortype="Default" type="Boolean" multivalued="false" visibility="in" notstoredvariable="true"/>
		<Variable name="A1756198713067" variable="applicationtype" displayname="applicationtype" editortype="Default" type="String" multivalued="false" visibility="in" description="Application is Profile or Server" notstoredvariable="true"/>
	</Variables>
</Workflow>
