...
<Workflow version="1.0">
	<Definition name="bwr_inititsmticketsperapplicationservicenow_1" statictitle="inititsmticketsperapplication" scriptfile="workflow/bw_iasreview/inititsmticketsperapplicationjira.javascript" displayname="inititsmticketsperapplication" type="builtin-technical-workflow" technical="true">
		<Component name="CSTART" type="startactivity" x="247" y="-86" w="200" h="114" title="Start" compact="true" outexclusive="true">
			<Ticket create="true"/>
			<Actions function="createChangeInfos">
				...
				<Action name="U1756204528274" action="update" attribute="changetitle" newvalue="Changes are requested for server {dataset.applicationdisplayname.get(0)}" condition="dataset.applicationtype.get().equals(&apos;Server&apos;)"/>
			</Actions>
		</Component>
		<Component name="CEND" type="endactivity" x="247" y="1188" w="200" h="98" title="End" compact="true" inexclusive="true"/>
		...
		<Link name="L1655224077815" source="C1655282499443" target="C1655285039929_8" priority="2"/>
		<Component name="C1655282499443" type="callactivity" x="121" y="168" w="300" h="98" title="create ticket" outexclusive="true">
			<Process workflowfile="/workflow/bw_jira/createIssue.workflow">
				...
				<Output name="A1743105539975" variable="errorMessage" content="resultdescription"/>
			</Process>
		</Component>
		<Component name="C1655283825990" type="callactivity" x="121" y="349" w="300" h="98" title="add attachment">
		...
		<Component name="C1655283996202" type="callactivity" x="121" y="525" w="300" h="98" title="get ticket status">
		...
		<Component name="C1655285039929" type="variablechangeactivity" x="121" y="683" w="300" h="98" title="get status pretty string" inexclusive="true">
			<Actions function="computeStatus">
			</Actions>
		</Component>
		<Link name="L1655285152421" source="C1655285039929" target="C1655285039929_2" priority="1"/>
		<Component name="C1655285385163" type="updateticketreviewactivity" x="121" y="986" w="300" h="98" title="update ticket number &amp; review status">
		...
		<Component name="C1657213098824_1" type="variablechangeactivity" x="121" y="21" w="300" h="98" title="attachment name">
			<Actions>
		...
		<Link name="L1663154636364" source="CSTART" target="C1657213098824_1" priority="1"/>
		<Component name="C1655285039929_8" type="variablechangeactivity" x="451" y="842" w="300" h="98" title="prepare tickets updates" inexclusive="true">
			<Actions>
				<Action name="U1655365636898" action="update" attribute="currentdatetime" newvalue="{new Date().toLDAPString()}"/>
		...
		<Component name="C1655285385163_3" type="updateticketreviewactivity" x="451" y="986" w="300" h="98" title="update ticket number &amp; review status">
			<UpdateTicketReview ticketreviewnumbervariable="remediationrecorduid">
				<Attribute name="status" attribute="ticketstatus"/>
				<Attribute name="custom2" attribute="ticketclosedstatus"/>
				<Attribute name="actiondate" attribute="currentdatetime"/>
		...
		<Link name="L1743105123816_2" source="C1655285039929_8" target="C1655285385163_3" priority="1"/>
		<Link name="L1743105477011" source="C1655285385163_3" target="CEND" priority="1"/>
	</Definition>
	<Variables>
		...
		<Variable name="A1743105518505" variable="resultdescription" displayname="resultdescription" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1743105904730" variable="retrymode" displayname="retrymode" editortype="Default" type="Boolean" multivalued="false" visibility="in" notstoredvariable="true"/>
		<Variable name="A1756204475161" variable="applicationtype" displayname="applicationtype" editortype="Default" type="String" multivalued="false" visibility="in" notstoredvariable="true"/>
	</Variables>
</Workflow>
