...
<Workflow version="1.0">
	<Definition name="bwr_inititsmticketspergroupmembershipservicenow" statictitle="inititsmticketspergroupmembership" scriptfile="workflow/bw_iasreview/inititsmticketspergroupmembershipservicenow.javascript" displayname="inititsmticketspergroupmembership" type="builtin-technical-workflow" technical="true">
		<Component name="CSTART" type="startactivity" x="495" y="-540" w="200" h="114" title="Start" compact="true" outexclusive="true">
			...
			<Actions function="createChangeInfos">
				...
				<Action name="U1655217131432" action="executeview" viewname="bwiasr_initgroupmembershipperrepobv" append="false" attribute="accountidentifier">
					...
					<ViewAttribute name="P1655217131432_5" attribute="reviewstatus" variable="reviewstatus"/>
					<ViewAttribute name="P1655217131432_6" attribute="reviewactiondate" variable="reviewactiondate"/>
					<ViewAttribute name="P1655217131432_7" attribute="reviewcomment" variable="reviewcomment"/>
					<ViewAttribute name="P1655217131432_8" attribute="reviewerfullname" variable="reviewerfullname"/>
					<ViewAttribute name="P1655217131432_9" attribute="reviewerhrcode" variable="reviewerhrcode"/>
					<ViewAttribute name="P1655217131432_10" attribute="remediationrecorduid" variable="remediationrecorduid"/>
					<ViewAttribute name="P1655217131432_11" attribute="groupcode" variable="groupcode"/>
					<ViewAttribute name="P1655217131432_12" attribute="groupdisplayname" variable="groupdisplayname"/>
					<ViewAttribute name="P1655217131432_13" attribute="grouprepositorydisplayname" variable="grouprepositorydisplayname"/>
					<ViewAttribute name="P1655217131432_14" attribute="repositorydisplayname" variable="repositorydisplayname"/>
					<ViewAttribute name="P1655217131432_15" attribute="repositorybwr_remediation_repository_type" variable="remediationtype"/>
				</Action>
				<Action name="U1655220598185" action="update" attribute="changetitle" newvalue="Group membership changes are requested for repository {dataset.grouprepositorydisplayname.get()}"/>
			</Actions>
		</Component>
		...
		<Component name="C1655282499443" type="callactivity" x="120" y="168" w="300" h="98" title="create incident" outexclusive="true">
			<Process workflowfile="/workflow/bw_servicenow/createservicenowincident.workflow">
				...
				<Output name="A1741631260258" variable="resultdescription" content="resultdescription"/>
			</Process>
		</Component>
		...
		<Component name="N1655284989441" type="note" x="1321" y="140" w="279" h="191" title="SERVICENOW INCIDENT STATUS&#xA;&#xA;1 New&#xA;2 In Progress&#xA;3 On Hold&#xA;4 On Hold&#xA;5 On Hold&#xA;6 Resolved&#xA;7 Closed&#xA;8 Canceled"/>
		...
		<Component name="C1655282499443_1" type="callactivity" x="633" y="168" w="300" h="98" title="create change request" outexclusive="true">
			<Process workflowfile="/workflow/bw_servicenow/createservicenowchangerequest.workflow">
				...
				<Input name="A1747043654457" variable="oauth_expires_in" content="itsmtokenexpiresin"/>
				<Input name="A1747043660049" variable="oauth_scope" content="itsmscope"/>
				<Output name="A1741631270646" variable="resultdescription" content="resultdescription"/>
			</Process>
		</Component>
		...
		<Link name="L1656063810004" source="C1655282499443_1" target="C1655285039929_7" priority="2"/>
		...
		<Component name="N1656078420247" type="note" x="1330" y="-64" w="300" h="185" title="SERVICENOW CHANGE REQUEST STATUS&#xA;&#xA;-5 New&#xA;-4 Assess&#xA;-3 Authorize&#xA;-2 Scheduled&#xA;-1 Implement&#xA;0 Review&#xA;3 Closed&#xA;4 Canceled"/>
		...
		<Component name="C1655285039929_3" type="variablechangeactivity" x="634" y="845" w="300" h="98" title="prepare tickets updates" inexclusive="true">
			<Actions>
				<Action name="U1655286096596" action="update" attribute="shortlink" newvalue="https://{dataset.itsmurl.get()}/task.do?sys_id={dataset.ticketid.get()}"/>
				<Action name="U1655295807040" action="multiresize" attribute="remediationrecorduid" attribute1="ticketextref1" attribute2="ticketextref2" attribute3="ticketextrefinstance" attribute4="ticketextrefurl" attribute5="ticketstatus" attribute6="ticketclosedstatus"/>
				<Action name="U1655295826647" action="multireplace" attribute="ticketextref1" newvalue="{dataset.ticketnumber.get()}"/>
		...
		<Component name="C1655285385163_5" type="updateticketreviewactivity" x="976" y="986" w="300" h="98" title="update ticket number &amp; review status">
			<UpdateTicketReview ticketreviewnumbervariable="remediationrecorduid">
				<Attribute name="status" attribute="ticketstatus"/>
				<Attribute name="actiondate" attribute="currentdatetime"/>
				<Attribute name="custom3" attribute="remediationtype"/>
		...
		<Component name="C1655285039929_7" type="variablechangeactivity" x="976" y="845" w="300" h="98" title="prepare tickets updates" inexclusive="true">
			<Actions>
				<Action name="U1655365636898" action="update" attribute="currentdatetime" newvalue="{new Date().toLDAPString()}"/>
				<Action name="U1741617078445" action="update" attribute="ticketstatus" newvalue="error"/>
				<Action name="U1741635027165" action="update" attribute="ticketclosedstatus" newvalue="3"/>
			</Actions>
		</Component>
		<Link name="L1741617122027_2" source="C1655285039929_7" target="C1655285385163_5" priority="1"/>
		<Link name="L1741631209558" source="C1655285385163_5" target="CEND" priority="1"/>
		<Component name="C1655285039929_8" type="variablechangeactivity" x="-225" y="842" w="300" h="98" title="prepare tickets updates" inexclusive="true">
			<Actions>
				<Action name="U1655365636898" action="update" attribute="currentdatetime" newvalue="{new Date().toLDAPString()}"/>
				<Action name="U1741617078445" action="update" attribute="ticketstatus" newvalue="error"/>
				<Action name="U1741634969009" action="update" attribute="ticketclosedstatus" newvalue="3"/>
			</Actions>
		</Component>
		<Component name="C1655285385163_6" type="updateticketreviewactivity" x="-225" y="986" w="300" h="98" title="update ticket number &amp; review status">
			<UpdateTicketReview ticketreviewnumbervariable="remediationrecorduid">
				<Attribute name="status" attribute="ticketstatus"/>
				<Attribute name="actiondate" attribute="currentdatetime"/>
				<Attribute name="custom3" attribute="remediationtype"/>
		...
		<Link name="L1741613282412_2" source="C1655285039929_8" target="C1655285385163_6" priority="1"/>
		<Link name="L1741631238389" source="C1655285385163_6" target="CEND" priority="1"/>
	</Definition>
	<Variables>
		...
		<Variable name="A1747054925642" variable="itsmauthenticationtype" displayname="itsmauthenticationtype" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1747054930236" variable="itsmtokengranttype" displayname="itsmtokengranttype" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1747054934533" variable="itsmclientid" displayname="itsmclientid" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1747054939535" variable="itsmclientsecret" displayname="itsmclientsecret" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1747054944131" variable="itsmrefreshtoken" displayname="itsmrefreshtoken" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1747054950163" variable="itsmtokenexpiresin" displayname="itsmtokenexpiresin" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1747054958329" variable="itsmtokenexpirationdate" displayname="itsmtokenexpirationdate" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1747054962543" variable="itsmscope" displayname="itsmscope" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1741631106959" variable="resultdescription" displayname="resultdescription" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1741807245176" variable="emptycomment" displayname="emptycomment" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1741811509997" variable="retrymode" displayname="retrymode" editortype="Default" type="Boolean" multivalued="false" visibility="in" notstoredvariable="true"/>
	</Variables>
</Workflow>
