...
<Workflow version="1.0">
	<Definition name="bwr_refreshitsmticketsperrepositoryservicenow" statictitle="refreshitsmticketsperrepository" scriptfile="workflow/bw_iasreview/refreshitsmticketsperrepositoryservicenow.javascript" displayname="refreshitsmticketsperrepository" type="builtin-technical-workflow" technical="true">
		<Component name="CSTART" type="startactivity" x="225" y="-106" w="200" h="114" title="Start" compact="true">
			...
			<Actions function="init">
				...
				<Action name="U1655368117141" action="executeview" viewname="bwiasr_pendingaccountsperrepo" append="false" attribute="remediationrecorduid">
		...
		<Component name="C1655368217153" type="callactivity" x="99" y="110" w="300" h="98" title="get latest tickets status">
			<Process workflowfile="/workflow/bw_servicenow/getservicenowtaskstatus.workflow">
				...
				<Input name="A1746458614204" variable="authentication_type" content="itsmauthenticationtype"/>
				<Input name="A1746458626933" variable="oauth_client_id" content="itsmclientid"/>
				<Input name="A1746458632803" variable="oauth_client_secret_password" content="itsmclientsecret"/>
				<Input name="A1746458648320" variable="oauth_grant_type" content="itsmtokengranttype"/>
				<Input name="A1746458659589" variable="oauth_refresh_token" content="itsmrefreshtoken"/>
				<Input name="A1746458670857" variable="oauth_expiration_date" content="itsmtokenexpirationdate"/>
				<Input name="A1746458708858" variable="oauth_expires_in" content="itsmtokenexpiresin"/>
				<Input name="A1747039448440" variable="oauth_scope" content="itsmscope"/>
			</Process>
		</Component>
	...
	<Variables>
		...
		<Variable name="A1747039430488" variable="itsmscope" displayname="itsmscope" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
	</Variables>
</Workflow>
