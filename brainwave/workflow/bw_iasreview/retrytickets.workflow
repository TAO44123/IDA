...
<Workflow version="1.0">
	<Definition name="bwr_retrytickets" statictitle="retry tickets" scriptfile="workflow/bw_iasreview/retrytickets.javascript" description="Retry erroring remediation" displayname="retry tickets" technical="true">
		...
		<Component name="CEND" type="endactivity" x="168" y="339" w="200" h="98" title="End" compact="true"/>
		<Component name="C1655456450663" type="callactivity" x="42" y="151" w="300" h="98" title="init itsm&amp;mail tickets">
			<Process workflowfile="/workflow/bw_iasreview/inititsmtickets.workflow">
				...
				<Input name="A1741790945155" variable="retrymode" content="retrymode"/>
			</Process>
		</Component>
		<Link name="L1655456464901" source="C1655456450663" target="CEND" priority="1"/>
		<Component name="N1655456488799" type="note" x="412" y="49" w="416" h="170" title="Retry erroring remediation tickets&#xA;(remediation tickets with closedstatus=3)"/>
		<Link name="L1741788336423" source="CSTART" target="C1655456450663" priority="1"/>
	</Definition>
	<Roles>
	...
	<Variables>
		...
		<Variable name="A1741788575223" variable="retrymode" displayname="retrymode" editortype="Default" type="Boolean" multivalued="false" visibility="local" initialvalue="true" notstoredvariable="true"/>
	</Variables>
</Workflow>
