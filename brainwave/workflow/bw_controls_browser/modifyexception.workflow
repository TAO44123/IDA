...
<Workflow version="1.0">
	<Definition name="modifyexception" displayname="Modify exception" scriptfile="workflow/bw_controls_browser/empty.javascript" statictitle="Modify exception" description="Modify exception" technical="true" type="builtin-technical-workflow">
		<Component name="CSTART" type="startactivity" x="437" y="44" w="200" h="114" title="Start - modifyexception" compact="true">
			...
			<Actions>
				<Action name="U1637681124246" action="update" attribute="targetuid" newvalue="{ dataset.targetuids.get(0) }" condition="(! dataset.isEmpty(&apos;targetuids&apos;))"/>
			</Actions>
		</Component>
		<Component name="CEND" type="endactivity" x="437" y="347" w="200" h="98" title="End - modifyexception" compact="true">
			<Actions>
		...
		<Component name="C1449673983071" type="writeexceptionactivity" x="311" y="161" w="300" h="98" title="Modify exception">
			<WriteException name="writeexception" controlcode="controlcode" resulttype="targettype" entityuid="targetuid" reason="reason" issuername="issuerName" begindate="begindate" enddate="enddate" custom1="uploadsession"/>
			<Output name="output" writeexceptionstatusvariable="result"/>
		</Component>
		<Link name="L1602763030770" source="C1449673983071" target="CEND" priority="2"/>
	</Definition>
	<Variables>
		...
		<Variable name="A1637681087520" variable="targetuids" displayname="Target uids" editortype="Default" type="String" multivalued="true" visibility="in" description="Target uids (for calling via modifyexceptions)" notstoredvariable="true"/>
	</Variables>
	<Roles>
