...
function addServiceNowTextAttachement() {
    ...
    var /*String*/ filename = dataset.attachmentfilename.get();
    var /*String*/ textdata = dataset.attachmentcontent.get();

    var res = addTextAttachment(authenticationProperties, 'change_request', sysid, filename, textdata);
