...
<Workflow version="1.0">
	<Definition name="addservicenowincidenttextattachement" displayname="add a text attachment to an incident" description="add a text attachment to an incident" scriptfile="/workflow/bw_servicenow/addservicenowincidenttextattachement.javascript" statictitle="add a text attachment to an incident" technical="true" type="builtin-technical-workflow">
	...
	<Variables>
		...
		<Variable name="A1445621445357" variable="incident_state" displayname="incident state" editortype="Default" type="String" multivalued="false" visibility="out" description="ticket status as a string with a number:&#xA; * 1 New&#xA; * 2 Active&#xA; * 3 Awaiting Problem&#xA; * 4 Awaiting User Info&#xA; * 5 Awaiting Evidence&#xA; * 6 Resolved &#xA; * 7 Closed" notstoredvariable="false"/>
		<Variable name="A1474617370727" variable="attachmentcontent" displayname="attachment content" editortype="Default" type="String" multivalued="false" visibility="in" description="attachment content as a text" notstoredvariable="false"/>
		<Variable name="A1474617388777" variable="attachmentfilename" displayname="attachment file name" editortype="Default" type="String" multivalued="false" visibility="in" description="attachment file name as it will be viewed in the SN ticket" notstoredvariable="false"/>
