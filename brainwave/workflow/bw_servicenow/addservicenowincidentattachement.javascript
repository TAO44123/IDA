...
function addServiceNowTextAttachement() {
    ...
    var /*String*/ attachmentcanonicalpath = dataset.attachmentcanonicalpath.get();

    var res = addTextfileAttachment(authenticationProperties, 'incident', sysid, attachmentcanonicalpath);
    try {
        if (res == null) {
