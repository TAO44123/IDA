...
<Workflow version="1.0">
	<Definition name="addservicenowchangerequesttextattachement" displayname="add a text attachment to a change request" description="add a text attachment to a change request" scriptfile="/workflow/bw_servicenow/addservicenowchangerequesttextattachement.javascript" statictitle="add a text attachment to a change request" technical="true" type="builtin-technical-workflow">
