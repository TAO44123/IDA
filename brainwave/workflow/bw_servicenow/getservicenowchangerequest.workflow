...
<Workflow version="1.0">
	<Definition name="getservicenowchangerequest" displayname="Get a ServiceNow change request status" description="Get a ServiceNow change request status" scriptfile="/workflow/bw_servicenow/getservicenowchangerequest.javascript" technical="true" type="builtin-technical-workflow">
		<Component name="CSTART" type="startactivity" x="43" y="120" w="200" h="114" title="Start" compact="true">
			...
			<FormVariable name="A1445621629218" variable="ticketid" action="input" mandatory="false" longlist="false"/>
		</Component>
		<Component name="CEND" type="endactivity" x="542" y="120" w="200" h="98" title="End" compact="true"/>
		<Component name="C1445621549362" type="scriptactivity" x="227" y="95" w="200" h="98" title="get ServiceNow change request status">
			<Script onscriptexecute="getServiceNowChangeRequest"/>
		</Component>
	...
	<Variables>
		...
		<Variable name="A1445612319421" variable="short_description" displayname="short description" editortype="Default" type="String" multivalued="false" visibility="out" description="short description of the change request" notstoredvariable="false"/>
		...
		<Variable name="A1445612754092" variable="ticketid" displayname="ServiceNow ticket ID" editortype="Default" type="String" multivalued="false" visibility="in" description="ServiceNow internal change request ticket ID (sys_id) generated, this id must be used for further ticket references through API calls" notstoredvariable="false"/>
		<Variable name="A1445685533427" variable="change_state" displayname="change state" editortype="Default" type="String" multivalued="false" visibility="out" description="ticket status as a string with a number:&#xA; * 1 New&#xA; * 2 Active&#xA; * 3 Awaiting Problem&#xA; * 4 Awaiting User Info&#xA; * 5 Awaiting Evidence&#xA; * 6 Resolved &#xA; * 7 Closed" notstoredvariable="false"/>
