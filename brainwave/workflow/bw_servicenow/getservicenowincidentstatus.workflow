...
<Workflow version="1.0">
	<Definition name="getservicenowincidentstatus" displayname="Get a ServiceNow incident status" description="Get a ServiceNow incident status" scriptfile="/workflow/bw_servicenow/getservicenowincidentstatus.javascript" technical="true" type="builtin-technical-workflow">
