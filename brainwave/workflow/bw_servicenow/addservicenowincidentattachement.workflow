...
<Workflow version="1.0">
	<Definition name="addservicenowincidentattachement" displayname="add an attachment to an incident" description="add an attachment to an incident provided as a local file" scriptfile="/workflow/bw_servicenow/addservicenowincidentattachement.javascript" statictitle="add an attachment to an incident" technical="true" type="builtin-technical-workflow">
		...
		<Component name="C1474617183869" type="scriptactivity" x="179" y="41" w="200" h="98" title="add an attachement">
	...
	<Variables>
		...
		<Variable name="A1475328878036" variable="attachmentcanonicalpath" displayname="attachment canonical path" editortype="Default" type="String" multivalued="false" visibility="in" description="attachment canonical path" notstoredvariable="false"/>
