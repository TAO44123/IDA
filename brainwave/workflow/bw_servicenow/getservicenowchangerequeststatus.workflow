...
<Workflow version="1.0">
	<Definition name="getservicenowchangerequeststatus" displayname="Get a ServiceNow changerequest status" description="Get a ServiceNow changerequest status" scriptfile="/workflow/bw_servicenow/getservicenowchangerequeststatus.javascript" technical="true" type="builtin-technical-workflow">
