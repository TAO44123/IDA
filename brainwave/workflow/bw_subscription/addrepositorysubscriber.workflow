...
<Workflow version="1.0">
	<Definition name="bw_subscription_addrepositorysubscriber" statictitle="add repository subscriber" scriptfile="/workflow/bw_subscription/addapplicationsubscriber.javascript" displayname="add repository subscriber" type="builtin-technical-workflow" technical="true">
		<Component name="CSTART" type="startactivity" x="73" y="157" w="200" h="114" title="Start" compact="true">
			<Ticket create="true"/>
			<Actions>
				<Action name="U1638796070644" action="multiresize" attribute="subscriber" attribute1="reportids" attribute2="repositories" attribute3="subscribed"/>
				<Action name="U1643104813249" action="multireplace" attribute="repositories" newvalue="{dataset.repository.get()}"/>
				<Action name="U1638796107401" action="multireplace" attribute="reportids" newvalue="{dataset.reportid.get()}"/>
				<Action name="U1643104956363" action="multireplace" attribute="subscribed" newvalue="{true}"/>
			</Actions>
		...
		<Component name="C1638796122736" type="metadataactivity" x="227" y="132" w="300" h="98" title="create metadata">
			<Metadata action="C" schema="bw_subscription_repository">
	...
	<Variables>
		...
		<Variable name="A1643104708549" variable="repository" displayname="repository" editortype="Ledger Repository" type="String" multivalued="false" visibility="in" description="Repository to subscribe" notstoredvariable="true"/>
		<Variable name="A1643104734818" variable="repositories" displayname="repositories" editortype="Ledger Repository" type="String" multivalued="true" visibility="local" description="internal variable" notstoredvariable="true"/>
	</Variables>
	<Roles>
