...
<Workflow version="1.0">
	<Definition name="bwaccess360_computeRoleMetadata" statictitle="Finalize Role Content Review" scriptfile="workflow/bw_iasreview2/mng/genReport.javascript" technical="true" type="builtin-technical-workflow" displayname="{dataset.campaignid}" releaseontimeout="true">
		<Component name="CSTART" type="startactivity" x="220" y="81" w="200" h="114" title="bwaccess360_computeRoleMetadata - Start" compact="true">
			<Ticket create="true">
			...
			<Actions>
				<Action name="U1698052677246" action="executeview" viewname="bwiasr_listcampaignroles" append="false" attribute="isafullreview">
					...
					<ViewAttribute name="P1698052677246_8" attribute="uid" variable="roleuids"/>
				</Action>
		...
		<Component name="CEND" type="endactivity" x="220" y="528" w="200" h="98" title="bwaccess360_computeRoleMetadata - End" compact="true" inexclusive="true"/>
		<Component name="C1698050374020" type="callactivity" x="94" y="203" w="300" h="98" title="Make review tickets as the latest ones" outexclusive="true">
			<Process workflowfile="/workflow/bw_access360/markLatestRoleReviewStatus.workflow">
				<Input name="A1698066509502" variable="campaignid" content="campaignid"/>
			</Process>
		</Component>
		<Component name="C1698050387369" type="metadataactivity" x="94" y="360" w="300" h="98" title="Mark roles as reviewed (compliance)">
			<Metadata action="C" schema="bwr_rolesreviewstatus">
				<Repository/>
				...
				<Group group1="roleuids"/>
				<Permission permission1="roleuids"/>
			</Metadata>
		</Component>
		<Link name="L1698050400903" source="C1698050374020" target="C1698050387369" priority="1" labelcustom="true" label="Everything as been reviewed" expression="(dataset.isEmpty(&apos;nbnotreviewed&apos;) || dataset.nbnotreviewed.get()==0) &amp;&amp; !dataset.isEmpty( &apos;isafullreview&apos; ) &amp;&amp; &apos;true&apos;.equalsIgnoreCase( dataset.isafullreview.get(0) )"/>
	...
	<Variables>
		...
		<Variable name="A1698050907440" variable="campaigntitles" displayname="campaign titles" editortype="Default" type="String" multivalued="true" visibility="out" notstoredvariable="false"/>
		...
		<Variable name="A1765202918046" variable="roleuids" displayname="roleuids" editortype="Ledger Permission" type="String" multivalued="true" visibility="local" notstoredvariable="true"/>
	</Variables>
	<ComplianceReport format="PDF">
	</ComplianceReport>
</Workflow>
