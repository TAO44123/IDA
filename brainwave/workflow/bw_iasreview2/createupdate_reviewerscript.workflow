...
<Workflow version="1.0">
	<Definition name="createupdate_reviewerscript" statictitle="createupdate reviewer script" scriptfile="/workflow/bw_iasreview2/createupdate_mailtemplate.javascript" technical="true" type="builtin-technical-workflow">
		<Component name="CSTART" type="startactivity" x="449" y="72" w="200" h="114" title="Start" compact="true">
			...
			<FormVariable name="A1753092810228" variable="script" action="input" mandatory="true" longlist="false"/>
		...
		<Component name="C1753090928777" type="metadataactivity" x="322" y="152" w="300" h="98" title="update mail template">
			<Metadata action="C" schema="bwr_reviewerscript" outmetadatauid="uids">
				<Data subkey="code" string1="label" string2="review_type" details="script"/>
			</Metadata>
		</Component>
	...
	<Variables>
		<Variable name="A1753090377264" variable="script" displayname="reviewer script" editortype="Default" type="String" multivalued="true" visibility="in" notstoredvariable="true"/>
