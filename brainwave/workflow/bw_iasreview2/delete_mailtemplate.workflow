...
<Workflow version="1.0">
	<Definition name="bwr_delete_mail_template" statictitle="create mailtemplate" scriptfile="/workflow/bw_iasreview2/create_reviewdef.javascript" type="builtin-technical-workflow" technical="true">
		...
		<Component name="C1679512881969" type="metadataactivity" x="149" y="115" w="182" h="98" title="delete review def md">
			<Metadata schema="bwr_mailtemplate" action="D" metadatauid="uids">
				<Data/>
			</Metadata>
		</Component>
