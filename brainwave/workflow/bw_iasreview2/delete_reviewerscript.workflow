...
<Workflow version="1.0">
	<Definition name="bwr_delete_reviewer_script" statictitle="delete reviewer script" scriptfile="/workflow/bw_iasreview2/create_reviewdef.javascript" type="builtin-technical-workflow" technical="true">
		<Component name="CSTART" type="startactivity" x="216" y="32" w="200" h="114" title="Start" compact="true">
			...
			<FormVariable name="A1753098059730" variable="uids" action="input" mandatory="true" longlist="false"/>
		</Component>
		...
		<Component name="C1679512881969" type="metadataactivity" x="149" y="115" w="182" h="98" title="delete reviewer script">
			<Metadata schema="bwr_reviewerscript" action="D" metadatauid="uids">
				<Data/>
			</Metadata>
		</Component>
