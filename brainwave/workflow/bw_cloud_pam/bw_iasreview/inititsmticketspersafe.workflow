...
<Workflow version="1.0">
	<Definition name="bwr_inititsmticketspersafe" statictitle="inititsmticketspersafe" scriptfile="/workflow/bw_iasreview/inititsmticketsperapplication.javascript" displayname="inititsmticketspersafe" type="builtin-technical-workflow" technical="true">
		...
		<Component name="C1655219273375" type="callactivity" x="69" y="223" w="300" h="98" title="ServiceNow safe remediation">
			<Process workflowfile="/workflow/bw_cloud_pam/bw_iasreview/inititsmticketspersafeservicenow.workflow">
				...
				<Input name="A1741811641302" variable="retrymode" content="retrymode"/>
			</Process>
		</Component>
		...
		<Component name="C1655219273375_1" type="callactivity" x="407" y="223" w="300" h="98" title="Mail safe remediation">
			<Process workflowfile="/workflow/bw_cloud_pam/bw_iasreview/inititsmticketspersafemail.workflow">
				<Input name="A1655281696557" variable="remediationinstancecode" content="remediationinstancecode"/>
				<Input name="A1656434986700" variable="application" content="application"/>
				<Input name="A1656663103730" variable="debug" content="debug"/>
			</Process>
		...
		<Component name="C1655219273375_2" type="callactivity" x="764" y="223" w="300" h="98" title="Jira safe remediation">
			<Process workflowfile="/workflow/bw_cloud_pam/bw_iasreview/inititsmticketspersafejira.workflow">
				<Input name="A1655281696557" variable="remediationinstancecode" content="remediationinstancecode"/>
				<Input name="A1656434986700" variable="application" content="application"/>
				<Input name="A1656663103730" variable="debug" content="debug"/>
				<Input name="A1743106108515" variable="retrymode" content="retrymode"/>
			</Process>
		</Component>
	...
	<Variables>
		...
		<Variable name="A1741811588251" variable="retrymode" displayname="retrymode" editortype="Default" type="Boolean" multivalued="false" visibility="in" notstoredvariable="true"/>
	</Variables>
</Workflow>
