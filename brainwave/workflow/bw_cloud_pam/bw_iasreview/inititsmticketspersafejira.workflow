...
<Workflow version="1.0">
	<Definition name="bwr_inititsmticketspersafejira" statictitle="inititsmticketspersafe" scriptfile="workflow/bw_cloud_pam/bw_iasreview/inititsmticketspersafejira.javascript" displayname="inititsmticketspersafe" type="builtin-technical-workflow">
		<Component name="CSTART" type="startactivity" x="247" y="-86" w="200" h="114" title="Start" compact="true" outexclusive="true">
			...
			<Actions function="createChangeInfos">
				...
				<Action name="U1656434949150" action="executeview" viewname="bwiasr_initrightspersafebv" append="false" attribute="accountidentifier">
					...
					<ViewAttribute name="P1656434949150_6" attribute="safedisplayname" variable="applicationdisplayname"/>
					<ViewAttribute name="P1656434949150_7" attribute="vaultdisplayname" variable="vaultdisplayname"/>
					<ViewAttribute name="P1656434949150_8" attribute="permissioncode" variable="permissioncode"/>
					<ViewAttribute name="P1656434949150_9" attribute="permissiondisplayname" variable="permissiondisplayname"/>
					<ViewAttribute name="P1656434949150_10" attribute="remediationrecorduid" variable="remediationrecorduid"/>
					<ViewAttribute name="P1656434949150_11" attribute="safebwr_remediation_application_type" variable="remediationtype"/>
					<ViewAttribute name="P1656434949150_12" attribute="repositorydisplayname" variable="repositorydisplayname"/>
					<ViewAttribute name="P1656434949150_13" attribute="reviewactiondate" variable="reviewactiondate"/>
					<ViewAttribute name="P1656434949150_14" attribute="reviewcomment" variable="reviewcomment"/>
					<ViewAttribute name="P1656434949150_15" attribute="reviewerfullname" variable="reviewerfullname"/>
					<ViewAttribute name="P1656434949150_16" attribute="reviewerhrcode" variable="reviewerhrcode"/>
					<ViewAttribute name="P1656434949150_17" attribute="reviewstatus" variable="reviewstatus"/>
				</Action>
		...
		<Link name="L1655224077815" source="C1655282499443" target="C1655285039929_9" priority="2"/>
		<Component name="C1655282499443" type="callactivity" x="121" y="168" w="300" h="98" title="create ticket" outexclusive="true">
			<Process workflowfile="/workflow/bw_jira/createIssue.workflow">
				...
				<Output name="A1743105671904" variable="errorMessage" content="resultdescription"/>
			</Process>
		</Component>
		...
		<Component name="C1657213098824_1" type="variablechangeactivity" x="115" y="20" w="300" h="98" title="attachment name">
			<Actions>
		...
		<Component name="C1655285039929_9" type="variablechangeactivity" x="453" y="842" w="300" h="98" title="prepare tickets updates" inexclusive="true">
			<Actions>
				<Action name="U1655365636898" action="update" attribute="currentdatetime" newvalue="{new Date().toLDAPString()}"/>
		...
		<Component name="C1655285385163_4" type="updateticketreviewactivity" x="453" y="986" w="300" h="98" title="update ticket number &amp; review status">
			<UpdateTicketReview ticketreviewnumbervariable="remediationrecorduid">
				<Attribute name="status" attribute="ticketstatus"/>
				<Attribute name="custom2" attribute="ticketclosedstatus"/>
				<Attribute name="actiondate" attribute="currentdatetime"/>
		...
		<Link name="L1743105123816_3" source="C1655285039929_9" target="C1655285385163_4" priority="1"/>
		<Link name="L1743105630638" source="C1655285385163_4" target="CEND" priority="1"/>
	</Definition>
	<Variables>
		...
		<Variable name="A16564349491503" variable="applicationdisplayname" displayname="applicationdisplayname" multivalued="true" visibility="local" type="String" editortype="Default" notstoredvariable="false"/>
		...
		<Variable name="A1669045684667" variable="vaultdisplayname" displayname="Vault" editortype="Default" type="String" multivalued="true" visibility="local" notstoredvariable="true"/>
		<Variable name="A1743105662564" variable="resultdescription" displayname="resultdescription" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1743105946938" variable="retrymode" displayname="retrymode" editortype="Default" type="Boolean" multivalued="false" visibility="in" notstoredvariable="true"/>
	</Variables>
</Workflow>
