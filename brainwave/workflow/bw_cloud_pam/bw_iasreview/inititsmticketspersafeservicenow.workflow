...
<Workflow version="1.0">
	<Definition name="bwr_inititsmticketspersafeservicenow" statictitle="inititsmticketspersafe" scriptfile="workflow/bw_cloud_pam/bw_iasreview/inititsmticketspersafeservicenow.javascript" displayname="inititsmticketspersafe" type="builtin-technical-workflow" technical="true">
		<Component name="CSTART" type="startactivity" x="495" y="-540" w="200" h="114" title="Start" compact="true" outexclusive="true">
			...
			<Actions function="createChangeInfos">
				...
				<Action name="U1656434949150" action="executeview" viewname="bwiasr_initrightspersafebv" append="false" attribute="accountidentifier">
					<ViewParam name="P16564349491500" param="safe" paramvalue="{dataset.application.get()}"/>
					...
					<ViewAttribute name="P1656434949150_5" attribute="safedisplayname" variable="applicationdisplayname"/>
					<ViewAttribute name="P1656434949150_6" attribute="safecode" variable="applicationcode"/>
					...
					<ViewAttribute name="P1656434949150_15" attribute="permissiondisplayname" variable="permissiondisplayname"/>
					<ViewAttribute name="P1656434949150_16" attribute="safebwr_remediation_application_type" variable="remediationtype"/>
					<ViewAttribute name="P1656434949150_17" attribute="vaultdisplayname" variable="vaultdisplayname"/>
				</Action>
				<Action name="U1655220598185" action="update" attribute="changetitle" newvalue="Changes are requested for safe {dataset.applicationdisplayname.get(0)} in vault {dataset.vaultdisplayname.get()}"/>
			</Actions>
		</Component>
		...
		<Component name="C1655282499443" type="callactivity" x="120" y="168" w="300" h="98" title="create incident" outexclusive="true">
			<Process workflowfile="/workflow/bw_servicenow/createservicenowincident.workflow">
				...
				<Output name="A1741877122446" variable="resultdescription" content="resultdescription"/>
			</Process>
		</Component>
		...
		<Component name="N1655284989441" type="note" x="1465" y="267" w="279" h="191" title="SERVICENOW INCIDENT STATUS&#xA;&#xA;1 New&#xA;2 In Progress&#xA;3 On Hold&#xA;4 On Hold&#xA;5 On Hold&#xA;6 Resolved&#xA;7 Closed&#xA;8 Canceled"/>
		...
		<Component name="C1655282499443_1" type="callactivity" x="633" y="168" w="300" h="98" title="create change request" outexclusive="true">
			<Process workflowfile="/workflow/bw_servicenow/createservicenowchangerequest.workflow">
				...
				<Input name="A1747043654457" variable="oauth_expires_in" content="itsmtokenexpiresin"/>
				<Input name="A1747043660049" variable="oauth_scope" content="itsmscope"/>
				<Output name="A1741877164421" variable="resultdescription" content="resultdescription"/>
			</Process>
		</Component>
		...
		<Component name="N1656070964558" type="note" x="717" y="-516" w="300" h="174" title="string4 url&#xA;string5 ticket type&#xA;string6 login&#xA;string7 password&#xA;string8 caller&#xA;string9 assignment group"/>
		<Component name="N1656078420247" type="note" x="1474" y="63" w="300" h="185" title="SERVICENOW CHANGE REQUEST STATUS&#xA;&#xA;-5 New&#xA;-4 Assess&#xA;-3 Authorize&#xA;-2 Scheduled&#xA;-1 Implement&#xA;0 Review&#xA;3 Closed&#xA;4 Canceled"/>
		...
		<Component name="C1655285039929_3" type="variablechangeactivity" x="634" y="849" w="300" h="98" title="prepare tickets updates" inexclusive="true">
			<Actions>
				<Action name="U1655286096596" action="update" attribute="shortlink" newvalue="https://{dataset.itsmurl.get()}/task.do?sys_id={dataset.ticketid.get()}"/>
				<Action name="U1655295807040" action="multiresize" attribute="remediationrecorduid" attribute1="ticketextref1" attribute2="ticketextref2" attribute3="ticketextrefinstance" attribute4="ticketextrefurl" attribute5="ticketstatus" attribute6="ticketclosedstatus"/>
				<Action name="U1655295826647" action="multireplace" attribute="ticketextref1" newvalue="{dataset.ticketnumber.get()}"/>
		...
		<Component name="C1655285039929_5" type="variablechangeactivity" x="-209" y="842" w="300" h="98" title="prepare tickets updates" inexclusive="true">
			<Actions>
				<Action name="U1655365636898" action="update" attribute="currentdatetime" newvalue="{new Date().toLDAPString()}"/>
		...
		<Component name="C1655285385163_3" type="updateticketreviewactivity" x="-209" y="986" w="300" h="98" title="update ticket number &amp; review status">
			<UpdateTicketReview ticketreviewnumbervariable="remediationrecorduid">
				<Attribute name="status" attribute="ticketstatus"/>
				<Attribute name="actiondate" attribute="currentdatetime"/>
				<Attribute name="custom3" attribute="remediationtype"/>
		...
		<Link name="L1741807420638" source="C1655285385163_3" target="CEND" priority="1"/>
		<Component name="C1655285039929_6" type="variablechangeactivity" x="982" y="849" w="300" h="98" title="prepare tickets updates" inexclusive="true">
			<Actions>
				<Action name="U1655365636898" action="update" attribute="currentdatetime" newvalue="{new Date().toLDAPString()}"/>
				<Action name="U1741617078445" action="update" attribute="ticketstatus" newvalue="error"/>
		...
		<Component name="C1655285385163_4" type="updateticketreviewactivity" x="982" y="986" w="300" h="98" title="update ticket number &amp; review status">
			<UpdateTicketReview ticketreviewnumbervariable="remediationrecorduid">
				<Attribute name="status" attribute="ticketstatus"/>
				<Attribute name="actiondate" attribute="currentdatetime"/>
				<Attribute name="custom3" attribute="remediationtype"/>
		...
		<Link name="L1741807458548" source="C1655285385163_4" target="CEND" priority="1"/>
	</Definition>
	<Variables>
		...
		<Variable name="A1669124599089" variable="vaultdisplayname" displayname="Vault" editortype="Default" type="String" multivalued="true" visibility="local" notstoredvariable="true"/>
		<Variable name="A1741807589054" variable="emptycomment" displayname="emptycomment" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
		<Variable name="A1741811605788" variable="retrymode" displayname="retrymode" editortype="Default" type="Boolean" multivalued="false" visibility="in" notstoredvariable="true"/>
		<Variable name="A1741877099359" variable="resultdescription" displayname="resultdescription" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
	</Variables>
</Workflow>
