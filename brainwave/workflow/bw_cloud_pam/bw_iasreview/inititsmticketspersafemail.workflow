...
<Workflow version="1.0">
	<Definition name="bwr_inititsmticketspersafemail" statictitle="inititsmticketspersafe" scriptfile="workflow/bw_iasreview/inititsmticketsperapplicationmail.javascript" displayname="inititsmticketspersafe" type="builtin-technical-workflow" technical="true">
		<Component name="CSTART" type="startactivity" x="508" y="-540" w="200" h="114" title="Start" compact="true" outexclusive="true">
			...
			<Actions function="init">
				...
				<Action name="U1656434949150" action="executeview" viewname="bwiasr_initrightspersafebv" append="false" attribute="accountidentifier">
					...
					<ViewAttribute name="P1656434949150_4" attribute="safedisplayname" variable="applicationdisplayname"/>
					<ViewAttribute name="P1656434949150_5" attribute="safecode" variable="applicationcode"/>
					...
					<ViewAttribute name="P1656434949150_14" attribute="permissiondisplayname" variable="permissiondisplayname"/>
					<ViewAttribute name="P1656434949150_15" attribute="safebwr_remediation_application_type" variable="remediationtype"/>
					<ViewAttribute name="P1656434949150_16" attribute="vaultdisplayname" variable="vaultdisplayname"/>
				</Action>
				<Action name="U1655220598185" action="update" attribute="changetitle" newvalue="Changes are requested for safe {dataset.applicationdisplayname.get()} in vault {dataset.vaultdisplayname.get()}"/>
			</Actions>
		</Component>
		...
		<Component name="C1662538654815_1" type="startsubactivity" x="508" y="-428" w="300" h="50" compact="true" title="Subprocess start">
			<Iteration listvariable="accountidentifier">
				...
				<Variable name="A1669123161852" variable="vaultdisplayname"/>
			</Iteration>
		</Component>
		<Component name="C1662481348535_1" type="mailnotificationactivity" x="382" y="-318" w="300" h="98" title="Send notifications" outexclusive="true">
			<Notification name="mail" mail="A1662620745538" ignoreerror="true"/>
	...
	<Variables>
		...
		<Variable name="A1669122835560" variable="vaultdisplayname" displayname="Vault" editortype="Default" type="String" multivalued="true" visibility="local" notstoredvariable="true"/>
	</Variables>
	<Mails>
		<Mail name="A1662620745538" displayname="remediation mail" description="remediation mail" notifyrule="bwir_safeaccess_remediation" tolist="sendto_id">
			...
			<Param name="vaultdisplayname" variable="vaultdisplayname"/>
		</Mail>
	</Mails>
</Workflow>
