...
<Workflow version="1.0">
	<Definition name="bwf_updateaccountmanager" displayname="Update account manager {dataset.accountlogin}/{dataset.repositorycode} {dataset.action} {!dataset.isEmpty(&apos;managerfullname&apos;)?dataset.managerfullname.get():&apos;&apos;}" description="Update account manager&#xA;&#xA;Important&#xA;In order to use this workflow the following domains of expertise must be added during the data collection phase:&#xA;- businessowner&#xA;- technicalowner&#xA;&#xA;If you wish to use your own expertise domains please modify the managertype variable." scriptfile="workflow/bw_fragments/empty.javascript" type="builtin-technical-workflow" statictitle="Update account manager" technical="true">
		<Component name="CSTART_3" type="startactivity" x="172" y="44" w="200" h="114" title="Start - bwf_updateaccountmanager" compact="true" outexclusive="true" inexclusive="true">
			<FormVariable name="A1587452461150" variable="account" action="input" mandatory="true" longlist="false"/>
			...
			<Actions>
				...
				<Action name="U1587452267281" action="executeview" viewname="br_accountDetail" append="false" attribute="accountlogin">
					<ViewParam name="P15874522672810" param="uid" paramvalue="{dataset.account.get()}"/>
					<ViewAttribute name="P1587452267281_1" attribute="login" variable="accountlogin"/>
					<ViewAttribute name="P1587452267281_2" attribute="repository_code" variable="repositorycode"/>
				</Action>
				<Action name="U1436014795240" action="update" attribute="ticketdescription" newvalue="{dataset.action.get()} {dataset.managertype.get()} on {dataset.accountlogin.get()}.{!dataset.isEmpty(&apos;managerfullname&apos;)?(&apos; new manager set to &apos;+dataset.managerhrcode.get()+&apos;-&apos;+dataset.managerfullname.get()):&apos;&apos;}. {!dataset.isEmpty(&apos;comments&apos;)?dataset.comments.get():&apos;&apos;}" condition="(! dataset.isEmpty(&apos;action&apos;))"/>
				<Action name="U1586502279675" action="multifilter" structname="" attribute="initialManager" oldname="manager" remove="true" attribute1="iniitalDelegation" attribute2="initialComment" attribute3="initialDelegationbegindate" attribute4="initialDelegationenddate" attribute5="initialDelegationreason" attribute6="initialExpertisedomain" attribute7="initialPriority" attribute8="initialAccounts" condition=""/>
		...
		<Component name="CEND_3" type="endactivity" x="172" y="713" w="200" h="98" title="End - bwf_updateaccountmanager" compact="true" inexclusive="true">
			<Actions>
				<Action name="U1444925106570" action="update" attribute="status" newvalue="done"/>
			</Actions>
		</Component>
		<Component name="C1444907469698_3" type="writemanageractivity" x="96" y="301" w="200" h="98" title="set new owners">
			<WriteManager name="writemanager" entitytype="C" entityuid="initialAccounts" domaincode="initialExpertisedomain" identityvariable="initialManager" comment="initialComment" delegflag="iniitalDelegation" delegpriority="initialPriority" delegreason="initialDelegationreason" begindate="initialDelegationbegindate" enddate="initialDelegationenddate" action="A"/>
		</Component>
		...
		<Component name="C1586528010292_3" type="variablechangeactivity" x="94" y="152" w="204" h="98" title="add new entry to the list">
			<Actions>
				...
				<Action name="U1586502359976" action="multiadd" structname="" attribute="initialAccounts" oldname="account" duplicates="false" condition=""/>
	...
	<Variables>
		...
		<Variable name="A1586501581125" variable="initialAccounts" displayname="accounts" editortype="Default" type="String" multivalued="true" visibility="local" notstoredvariable="true"/>
