...
<Workflow version="1.0">
	<Definition name="bwf_updateapplicationmanager" displayname="Update application manager {dataset.applicationdisplayname} {dataset.action} {!dataset.isEmpty(&apos;managerfullname&apos;)?dataset.managerfullname.get():&apos;&apos;}" description="This workflow is used to update management information on an Application object in the Identity Ledger.&#xA;All modifications are directly written into the Identity Ledger and are automatically maintained from one timeslot to another by the collect engine.&#xA;&#xA;Two king of managers can be declared :&#xA;business owner = he is &quot;accountable&quot; for the application, mainly responsible for granting access rights and performing reviews&#xA;technical owner=he is &quot;responsible&quot; for the application, mainly responsible for performing  changes upon request&#xA;&#xA;Important&#xA;In order to use this workflow the following domains of expertise must be added during the data collection phase:&#xA;- businessowner&#xA;- technicalowner&#xA;&#xA;If you wish to use your own expertise domains please modify the managertype variable.&#xA;" scriptfile="workflow/bw_fragments/empty.javascript" type="builtin-technical-workflow" statictitle="Update application manager" technical="true">
		<Component name="CSTART" type="startactivity" x="151" y="20" w="200" h="114" title="Start - bwf_updateapplicationmanager" compact="true" outexclusive="true" inexclusive="true">
			...
			<Actions>
				...
				<Action name="U1586502279675" action="multifilter" structname="" attribute="initialManager" oldname="manager" remove="true" attribute1="iniitalDelegation" attribute2="initialApplications" attribute3="initialComment" attribute4="initialDelegationbegindate" attribute5="initialDelegationenddate" attribute6="initialDelegationreason" attribute7="initialExpertisedomain" attribute8="initialPriority" condition=""/>
		...
		<Component name="CEND" type="endactivity" x="151" y="689" w="200" h="98" title="End - bwf_updateapplicationmanager" compact="true" inexclusive="true">
			<Actions>
		...
		<Component name="C1444907469698" type="writemanageractivity" x="75" y="295" w="200" h="98" title="set new owners">
			<WriteManager name="writemanager" entitytype="A" entityuid="initialApplications" domaincode="initialExpertisedomain" identityvariable="initialManager" comment="initialComment" delegflag="iniitalDelegation" delegpriority="initialPriority" delegreason="initialDelegationreason" begindate="initialDelegationbegindate" enddate="initialDelegationenddate" action="A"/>
		</Component>
		...
		<Component name="C1444917358555" type="ticketreviewactivity" x="75" y="551" w="200" h="98" title="ticket review" inexclusive="true">
		...
		<Component name="C1586528010292" type="variablechangeactivity" x="73" y="128" w="204" h="98" title="add new entry to the list">
			<Actions>
				...
				<Action name="U1586502359976" action="multiadd" structname="" attribute="initialApplications" oldname="application" duplicates="false" condition=""/>
		...
		<Link name="L1591285988798" source="C1591285784239" target="C1444917358555" priority="1"/>
	...
	<Variables>
		...
		<Variable name="A1586501581125" variable="initialApplications" displayname="applications" editortype="Default" type="String" multivalued="true" visibility="local" notstoredvariable="true"/>
