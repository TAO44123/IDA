...
<Workflow version="1.0">
	<Definition name="bwf_updatepermissionmanager" displayname="Update permission manager {dataset.permissiondisplayname}/{dataset.applicationdisplayname} {dataset.action} {!dataset.isEmpty(&apos;managerfullname&apos;)?dataset.managerfullname.get():&apos;&apos;}" description="Update permission manager&#xA;&#xA;Important&#xA;In order to use this workflow the following domains of expertise must be added during the data collection phase:&#xA;- businessowner&#xA;- technicalowner&#xA;&#xA;If you wish to use your own expertise domains please modify the managertype variable." scriptfile="workflow/bw_fragments/empty.javascript" type="builtin-technical-workflow" statictitle="Update permission manager" technical="true">
		<Component name="CSTART_1" type="startactivity" x="162" y="39" w="200" h="114" title="Start - bwf_updatepermissionmanager" compact="true" outexclusive="true" inexclusive="true">
			<FormVariable name="A1587365973309" variable="permission" action="input" mandatory="true" longlist="false"/>
			...
			<Actions>
				...
				<Action name="U1436014223203" action="executeview" viewname="br_identityDetail" attribute="managerhrcode" append="false">
				...
				<Action name="U1587367235359" action="executeview" viewname="br_permissionDetail" append="false" attribute="applicationcode">
					<ViewParam name="P15873672353590" param="uid" paramvalue="{dataset.permission.get()}"/>
					<ViewAttribute name="P1587367235359_1" attribute="application_code" variable="applicationcode"/>
					<ViewAttribute name="P1587367235359_2" attribute="application_displayname" variable="applicationdisplayname"/>
					<ViewAttribute name="P1587367235359_3" attribute="code" variable="permissioncode"/>
					<ViewAttribute name="P1587367235359_4" attribute="displayname" variable="permissiondisplayname"/>
				</Action>
				<Action name="U1436014795240" action="update" attribute="ticketdescription" newvalue="{dataset.action.get()} {dataset.managertype.get()} on {dataset.applicationcode.get()}.{!dataset.isEmpty(&apos;managerfullname&apos;)?(&apos; new manager set to &apos;+dataset.managerhrcode.get()+&apos;-&apos;+dataset.managerfullname.get()):&apos;&apos;}. {!dataset.isEmpty(&apos;comments&apos;)?dataset.comments.get():&apos;&apos;}" condition="(! dataset.isEmpty(&apos;action&apos;))"/>
				<Action name="U1586502279675" action="multifilter" structname="" attribute="initialManager" oldname="manager" remove="true" attribute1="iniitalDelegation" attribute2="initialComment" attribute3="initialDelegationbegindate" attribute4="initialDelegationenddate" attribute5="initialDelegationreason" attribute6="initialExpertisedomain" attribute7="initialPriority" attribute8="initialPermissions" condition=""/>
		...
		<Component name="CEND_1" type="endactivity" x="162" y="708" w="200" h="98" title="End - bwf_updatepermissionmanager" compact="true" inexclusive="true">
			<Actions>
				<Action name="U1444925106570" action="update" attribute="status" newvalue="done"/>
			</Actions>
		</Component>
		<Component name="C1444907469698_1" type="writemanageractivity" x="86" y="304" w="200" h="98" title="set new owners">
			<WriteManager name="writemanager" entitytype="P" entityuid="initialPermissions" domaincode="initialExpertisedomain" identityvariable="initialManager" comment="initialComment" delegflag="iniitalDelegation" delegpriority="initialPriority" delegreason="initialDelegationreason" begindate="initialDelegationbegindate" enddate="initialDelegationenddate" action="A"/>
		</Component>
		<Component name="C1444917358555_1" type="ticketreviewactivity" x="86" y="570" w="200" h="98" title="ticket review" inexclusive="true">
		...
		<Component name="N1494333701389_2" type="note" x="676" y="63" w="300" h="177" title="Important&#xA;&#xA;In order to use this workflow the following domains of expertise must be added during the data collection phase:&#xA;- businessowner&#xA;- technicalowner&#xA;&#xA;If you wish to use your own expertise domains please modify the managertype variable."/>
		<Component name="C1586528010292_1" type="variablechangeactivity" x="84" y="147" w="204" h="98" title="add new entry to the list">
			<Actions>
				...
				<Action name="U1586502359976" action="multiadd" structname="" attribute="initialPermissions" oldname="permission" duplicates="false" condition=""/>
		...
		<Link name="L1444913689551_1" source="CSTART_1" target="C1591357482124" priority="2" expression="(dataset.equals(&apos;action&apos;, &apos;delete&apos;, false, true))" labelcustom="true" label="delete"/>
		...
		<Component name="C1591357482124" type="writemanageractivity" x="455" y="304" w="300" h="98" title="Delete">
			<WriteManager name="writemanager" delete="managerLink"/>
		</Component>
		<Link name="L1591357513947" source="C1591357482124" target="C1444917358555_1" priority="1"/>
		<Link name="L1591357548666" source="C1586528010292_1" target="C1444907469698_1" priority="1"/>
	</Definition>
	<Variables>
		...
		<Variable name="A1586501581125" variable="initialPermissions" displayname="permissions" editortype="Default" type="String" multivalued="true" visibility="local" notstoredvariable="true"/>
		...
		<Variable name="A1591357474182" variable="managerLink" editortype="Default" type="Number" multivalued="false" visibility="in" notstoredvariable="true"/>
		<Variable name="A1598364837791" variable="deletemanagerfullname" displayname="deletemanagerfullname" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
	</Variables>
	<Roles>
