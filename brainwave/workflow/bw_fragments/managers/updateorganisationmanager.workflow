...
<Workflow version="1.0">
	<Definition name="bwf_updateorganisationmanager" displayname="Update organisation manager {dataset.organisationdisplayname} {dataset.action} {!dataset.isEmpty(&apos;managerfullname&apos;)?dataset.managerfullname.get():&apos;&apos;}" description="Update organisation manager&#xA;&#xA;Important&#xA;In order to use this workflow the following domains of expertise must be added during the data collection phase:&#xA;- businessowner&#xA;- technicalowner&#xA;&#xA;If you wish to use your own expertise domains please modify the managertype variable." scriptfile="workflow/bw_fragments/empty.javascript" type="builtin-technical-workflow" statictitle="Update organisation manager" technical="true">
		<Component name="CSTART_2" type="startactivity" x="160" y="30" w="200" h="114" title="Start - bwf_updateorganisationmanager" compact="true" outexclusive="true" inexclusive="true">
			<FormVariable name="A1587547261886" variable="organisation" action="input" mandatory="true" longlist="false"/>
			...
			<Actions>
				...
				<Action name="U1587547664570" action="executeview" viewname="br_organisationDetail" append="false" attribute="organisationcode">
					<ViewParam name="P15875476645700" param="uid" paramvalue="{dataset.organisation.get()}"/>
					<ViewAttribute name="P1587547664570_1" attribute="code" variable="organisationcode"/>
					<ViewAttribute name="P1587547664570_2" attribute="displayname" variable="organisationdisplayname"/>
				</Action>
				<Action name="U1436014795240" action="update" attribute="ticketdescription" newvalue="{dataset.action.get()} {dataset.managertype.get()} on {dataset.organisationcode.get()}.{!dataset.isEmpty(&apos;managerfullname&apos;)?(&apos; new manager set to &apos;+dataset.managerhrcode.get()+&apos;-&apos;+dataset.managerfullname.get()):&apos;&apos;}. {!dataset.isEmpty(&apos;comments&apos;)?dataset.comments.get():&apos;&apos;}" condition="(! dataset.isEmpty(&apos;action&apos;))"/>
				<Action name="U1586502279675" action="multifilter" structname="" attribute="initialManager" oldname="manager" remove="true" attribute1="iniitalDelegation" attribute2="initialComment" attribute3="initialDelegationbegindate" attribute4="initialDelegationenddate" attribute5="initialDelegationreason" attribute6="initialExpertisedomain" attribute7="initialPriority" attribute8="initialOrganisations" condition=""/>
			...
			<Ticket create="true" createaction="true">
				...
				<Attribute name="custom1" attribute="organisation"/>
			</Ticket>
		...
		<Component name="CEND_2" type="endactivity" x="160" y="699" w="200" h="98" title="End - bwf_updateorganisationmanager" compact="true" inexclusive="true">
			<Actions>
				<Action name="U1444925106570" action="update" attribute="status" newvalue="done"/>
			</Actions>
		</Component>
		<Component name="C1444907469698_2" type="writemanageractivity" x="84" y="296" w="200" h="98" title="set new owners">
			<WriteManager name="writemanager" entitytype="O" entityuid="initialOrganisations" domaincode="initialExpertisedomain" identityvariable="initialManager" comment="initialComment" delegflag="iniitalDelegation" delegpriority="initialPriority" delegreason="initialDelegationreason" begindate="initialDelegationbegindate" enddate="initialDelegationenddate" action="A"/>
		</Component>
		<Component name="C1444917358555_2" type="ticketreviewactivity" x="84" y="561" w="200" h="98" title="ticket review" inexclusive="true">
            ...
            <Attribute name="custom1" attribute="managerfullname"/>				
				...
				<Repository/>
				<Group/>
				<Organisation organisationvariable="organisation"/>
			</TicketReview>
		</Component>
		<Component name="N1494333701389_3" type="note" x="706" y="37" w="300" h="177" title="Important&#xA;&#xA;In order to use this workflow the following domains of expertise must be added during the data collection phase:&#xA;- businessowner&#xA;- technicalowner&#xA;&#xA;If you wish to use your own expertise domains please modify the managertype variable."/>
		<Component name="C1586528010292_2" type="variablechangeactivity" x="82" y="138" w="204" h="98" title="add new entry to the list">
			<Actions>
				...
				<Action name="U1586502359976" action="multiadd" structname="" attribute="initialOrganisations" oldname="organisation" duplicates="false" condition=""/>
		...
		<Link name="L1444913689551_2" source="CSTART_2" target="C1591357376076" priority="2" expression="(dataset.equals(&apos;action&apos;, &apos;delete&apos;, false, true))" labelcustom="true" label="delete"/>
		<Link name="L1586528141141_2" source="CSTART_2" target="C1586528010292_2" priority="1" expression="(dataset.equals(&apos;action&apos;, &apos;create&apos;, false, true))" labelcustom="true" label="create"/>
		<Link name="L1444925089301_2" source="C1444907469698_2" target="C1444917358555_2" priority="1"/>
		<Link name="L1444917372446_2" source="C1444917358555_2" target="CEND_2" priority="1"/>
		<Component name="C1591357376076" type="writemanageractivity" x="437" y="296" w="300" h="98" title="Delete">
			<WriteManager name="writemanager" delete="managerLink"/>
		</Component>
		<Link name="L1591357407303" source="C1591357376076" target="C1444917358555_2" priority="1"/>
		<Link name="L1591357433594" source="C1586528010292_2" target="C1444907469698_2" priority="1"/>
	</Definition>
	<Variables>
		...
		<Variable name="A1436014511173" variable="TICKETTYPE" displayname="ticket type" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="false" initialvalue="ORGANISATIONMANAGER"/>
		...
		<Variable name="A1436080955950" variable="organisation" displayname="organisation" editortype="Ledger Organisation" type="String" multivalued="false" visibility="in" notstoredvariable="false" description="The group UID to update"/>
		<Variable name="A1436080988495" variable="organisationcode" displayname="organisation code" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="false"/>
		<Variable name="A1436080997946" variable="organisationdisplayname" displayname="organisation displayname" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="false"/>
		...
		<Variable name="A1586501581125" variable="initialOrganisations" displayname="organisations" editortype="Default" type="String" multivalued="true" visibility="local" notstoredvariable="true"/>
		...
		<Variable name="A1591357367517" variable="managerLink" editortype="Default" type="Number" multivalued="false" visibility="in" notstoredvariable="true"/>
		<Variable name="A1598364844501" variable="deletemanagerfullname" displayname="deletemanagerfullname" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
	</Variables>
	<Roles>
