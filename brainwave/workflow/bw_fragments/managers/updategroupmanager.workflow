...
<Workflow version="1.0">
	<Definition name="bwf_updategroupmanager" displayname="Update group manager {dataset.groupdisplayname}/{dataset.repositorydisplayname} {dataset.action} {!dataset.isEmpty(&apos;managerfullname&apos;)?dataset.managerfullname.get():&apos;&apos;}" description="Update group manager&#xA;&#xA;Important&#xA;In order to use this workflow the following domains of expertise must be added during the data collection phase:&#xA;- businessowner&#xA;- technicalowner&#xA;&#xA;If you wish to use your own expertise domains please modify the managertype variable." scriptfile="workflow/bw_fragments/empty.javascript" type="builtin-technical-workflow" statictitle="Update group manager" technical="true">
		<Component name="CSTART_2" type="startactivity" x="160" y="30" w="200" h="114" title="Start - bwf_updategroupmanager" compact="true" outexclusive="true" inexclusive="true">
			<FormVariable name="A1587398597388" variable="group" action="input" mandatory="true" longlist="false"/>
			...
			<Actions>
				...
				<Action name="U1587398893057" action="executeview" viewname="br_groupDetail" append="false" attribute="groupcode">
					<ViewParam name="P15873988930570" param="uid" paramvalue="{dataset.group.get()}"/>
					<ViewAttribute name="P1587398893057_1" attribute="code" variable="groupcode"/>
					<ViewAttribute name="P1587398893057_2" attribute="displayname" variable="groupdisplayname"/>
				</Action>
				<Action name="U1436014795240" action="update" attribute="ticketdescription" newvalue="{dataset.action.get()} {dataset.managertype.get()} on {dataset.groupcode.get()}.{!dataset.isEmpty(&apos;managerfullname&apos;)?(&apos; new manager set to &apos;+dataset.managerhrcode.get()+&apos;-&apos;+dataset.managerfullname.get()):&apos;&apos;}. {!dataset.isEmpty(&apos;comments&apos;)?dataset.comments.get():&apos;&apos;}" condition="(! dataset.isEmpty(&apos;action&apos;))"/>
				<Action name="U1586502279675" action="multifilter" structname="" attribute="initialManager" oldname="manager" remove="true" attribute1="iniitalDelegation" attribute2="initialComment" attribute3="initialDelegationbegindate" attribute4="initialDelegationenddate" attribute5="initialDelegationreason" attribute6="initialExpertisedomain" attribute7="initialPriority" attribute8="initialGroups" condition=""/>
		...
		<Component name="CEND_2" type="endactivity" x="160" y="699" w="200" h="98" title="End - bwf_updategroupmanager" compact="true" inexclusive="true">
			<Actions>
				<Action name="U1444925106570" action="update" attribute="status" newvalue="done"/>
			</Actions>
		</Component>
		<Component name="C1444907469698_2" type="writemanageractivity" x="84" y="303" w="200" h="98" title="set new owners">
			<WriteManager name="writemanager" entitytype="G" entityuid="initialGroups" domaincode="initialExpertisedomain" identityvariable="initialManager" comment="initialComment" delegflag="iniitalDelegation" delegpriority="initialPriority" delegreason="initialDelegationreason" begindate="initialDelegationbegindate" enddate="initialDelegationenddate" action="A"/>
		</Component>
		...
		<Component name="C1586528010292_2" type="variablechangeactivity" x="82" y="138" w="204" h="98" title="add new entry to the list">
			<Actions>
				...
				<Action name="U1586502359976" action="multiadd" structname="" attribute="initialGroups" oldname="group" duplicates="false" condition=""/>
		...
		<Link name="L1444913689551_2" source="CSTART_2" target="C1591363162017" priority="2" expression="(dataset.equals(&apos;action&apos;, &apos;delete&apos;, false, true))" labelcustom="true" label="delete"/>
		...
		<Component name="C1591363162017" type="writemanageractivity" x="466" y="303" w="300" h="98" title="Delete">
			<WriteManager name="writemanager" delete="managerLink"/>
		</Component>
		<Link name="L1591363194291" source="C1591363162017" target="C1444917358555_2" priority="1"/>
		<Link name="L1591363222846" source="C1586528010292_2" target="C1444907469698_2" priority="1"/>
	</Definition>
	<Variables>
		...
		<Variable name="A1586501581125" variable="initialGroups" displayname="groups" editortype="Default" type="String" multivalued="true" visibility="local" notstoredvariable="true"/>
		...
		<Variable name="A1591363153185" variable="managerLink" editortype="Default" type="Number" multivalued="false" visibility="in" notstoredvariable="true"/>
		<Variable name="A1598364851303" variable="deletemanagerfullname" displayname="deletemanagerfullname" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
	</Variables>
	<Roles>
