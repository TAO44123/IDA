...
<Workflow version="1.0">
	<Definition name="bwf_updateidentitymanager" displayname="Update identity manager {dataset.identityhrcode}/{dataset.identityfullname} {dataset.action} {!dataset.isEmpty(&apos;managerfullname&apos;)?dataset.managerfullname.get():&apos;&apos;}" description="Update identity manager&#xA;&#xA;Important&#xA;In order to use this workflow the following domains of expertise must be added during the data collection phase:&#xA;- identitymanager&#xA;If you wish to use your own expertise domains please modify the managertype variable." scriptfile="workflow/bw_fragments/empty.javascript" type="builtin-technical-workflow" statictitle="Update identity manager" technical="true">
		<Component name="CSTART_3" type="startactivity" x="172" y="44" w="200" h="114" title="Start - bwf_updateidentitymanager" compact="true" outexclusive="true" inexclusive="true">
			<Candidates name="role" role="A1435858866632"/>
			<Actions>
				<Action name="U1586451606328" action="default" attribute="managertype" newvalue="identitymanager"/>
				...
				<Action name="U1587452267281" action="executeview" viewname="br_identityDetail" append="false" attribute="identityhrcode">
					<ViewParam name="P15874522672810" param="uid" paramvalue="{dataset.identity.get()}"/>
					<ViewAttribute name="P1587452267281_1" attribute="hrcode" variable="identityhrcode"/>
					<ViewAttribute name="P1587452267281_2" attribute="fullname" variable="identityfullname"/>
				</Action>
				<Action name="U1436014795240" action="update" attribute="ticketdescription" newvalue="{dataset.action.get()} {dataset.managertype.get()} on {dataset.identityfullname.get()}.{!dataset.isEmpty(&apos;managerfullname&apos;)?(&apos; new manager set to &apos;+dataset.managerhrcode.get()+&apos;-&apos;+dataset.managerfullname.get()):&apos;&apos;}. {!dataset.isEmpty(&apos;comments&apos;)?dataset.comments.get():&apos;&apos;}" condition="(! dataset.isEmpty(&apos;action&apos;))"/>
				<Action name="U1586502279675" action="multifilter" structname="" attribute="initialManager" oldname="manager" remove="true" attribute1="iniitalDelegation" attribute2="initialComment" attribute3="initialDelegationbegindate" attribute4="initialDelegationenddate" attribute5="initialDelegationreason" attribute6="initialExpertisedomain" attribute7="initialPriority" attribute8="initialIdentities" condition=""/>
		...
		<Component name="CEND_3" type="endactivity" x="172" y="713" w="200" h="98" title="End - bwf_updateidentitymanager" compact="true" inexclusive="true">
			<Actions>
				<Action name="U1444925106570" action="update" attribute="status" newvalue="done"/>
			</Actions>
		</Component>
		<Component name="C1444907469698_3" type="writemanageractivity" x="96" y="301" w="200" h="98" title="set new manager">
			<WriteManager name="writemanager" entitytype="I" entityuid="initialIdentities" domaincode="initialExpertisedomain" identityvariable="initialManager" comment="initialComment" delegflag="iniitalDelegation" delegpriority="initialPriority" delegreason="initialDelegationreason" begindate="initialDelegationbegindate" enddate="initialDelegationenddate" action="A"/>
		</Component>
		<Component name="C1444917358555_3" type="ticketreviewactivity" x="96" y="575" w="200" h="98" title="ticket review" inexclusive="true">
		...
		<Component name="N1494333701389_4" type="note" x="705" y="68" w="300" h="177" title="Important&#xA;&#xA;In order to use this workflow the following domains of expertise must be added during the data collection phase:&#xA;- identitymanager&#xA;&#xA;If you wish to use your own expertise domains please modify the managertype variable."/>
		<Component name="C1586528010292_3" type="variablechangeactivity" x="94" y="152" w="204" h="98" title="add new entry to the list">
			<Actions>
				...
				<Action name="U1586502359976" action="multiadd" structname="" attribute="initialIdentities" oldname="identity" duplicates="false" condition=""/>
		...
		<Link name="L1444913689551_3" source="CSTART_3" target="C1591357027052" priority="2" expression="(dataset.equals(&apos;action&apos;, &apos;delete&apos;, false, true))" labelcustom="true" label="delete"/>
		<Link name="L1586528141141_3" source="CSTART_3" target="C1586528010292_3" priority="1" expression="(dataset.equals(&apos;action&apos;, &apos;create&apos;, false, true))" labelcustom="true" label="create"/>
		<Link name="L1444925089301_3" source="C1444907469698_3" target="C1444917358555_3" priority="1"/>
		<Link name="L1444917372446_3" source="C1444917358555_3" target="CEND_3" priority="1"/>
		<Component name="C1591357027052" type="writemanageractivity" x="465" y="301" w="300" h="98" title="Delete">
			<WriteManager name="writemanager" delete="managerLink"/>
		</Component>
		<Link name="L1591357069068" source="C1591357027052" target="C1444917358555_3" priority="1"/>
		<Link name="L1591357090609" source="C1586528010292_3" target="C1444907469698_3" priority="1"/>
	</Definition>
	<Variables>
		...
		<Variable name="A1436270374548" variable="identity" displayname="identity" editortype="Ledger Identity" type="String" multivalued="false" visibility="in" notstoredvariable="false" description="The identity UID to update"/>
		<Variable name="A1436270392724" variable="identityhrcode" displayname="identity hrcode" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="false"/>
		<Variable name="A1436270398176" variable="identityfullname" displayname="identity fullname" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="false"/>
		...
		<Variable name="A1436780414401" variable="managertype" displayname="manager type" editortype="Default" type="String" multivalued="false" visibility="in" description="Can be identitymanager&#xA;Add these values as an expertise domains during &#xA;the data collection phase.&#xA;Or edit the values to match existing expertise domains." notstoredvariable="false">
			<StaticValue name="identitymanager"/>
		</Variable>
		...
		<Variable name="A1586501581125" variable="initialIdentities" displayname="identities" editortype="Default" type="String" multivalued="true" visibility="local" notstoredvariable="true"/>
		...
		<Variable name="A1591356980069" variable="managerLink" editortype="Default" type="Number" multivalued="false" visibility="in" notstoredvariable="true"/>
		<Variable name="A1598364873399" variable="deletemanagerfullname" displayname="deletemanagerfullname" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="true"/>
	</Variables>	
	<Roles>
		<Role name="A1435858866632" icon="/reports/icons/48/people/personal_48.png" smallicon="/reports/icons/16/people/personal_16.png" displayname="managers" description="people who can start this process">
			<Rule name="A1601977859317" rule="updateidentitymanagerstart" description="People who can start an update the manager of an identity"/>
		</Role>
	</Roles>
</Workflow>
