...
<Workflow version="1.0">
	<Definition name="bwa_updateidentitytags" statictitle="update identity tags" description="update identity tags" scriptfile="workflow/bw_fragments/empty.javascript" type="builtin-technical-workflow" displayname="update identity tags" technical="true">
		<Component name="CSTART" type="startactivity" x="237" y="18" w="200" h="114" title="Start - bwa_updateidentitytags" compact="true" outexclusive="true">
			<Ticket create="true"/>
			<Candidates name="role" role="A1608287150800"/>
			<Actions>
				<Action name="U1619455782599" action="multiclean" attribute="tags" emptyvalues="true" duplicates="true"/>
				<Action name="U1608630236771" action="empty" attribute="identities"/>
				<Action name="U1608630285096" action="multiresize" attribute="tags" attribute1="identities"/>
				<Action name="U1608630303007" action="multireplace" attribute="identities" newvalue="{dataset.identity.get()}"/>
			</Actions>
		</Component>
		<Component name="CEND" type="endactivity" x="237" y="549" w="200" h="98" title="End - bwa_updateidentitytags" compact="true" inexclusive="true"/>
		...
		<Component name="C1608287218219" type="metadataactivity" x="111" y="420" w="300" h="98" title="update tags">
			<Metadata schema="bwa_identitytags" action="C">
		...
		<Component name="C1608575057008" type="variablechangeactivity" x="111" y="119" w="300" h="98" title="pick metadata uid">
			<Actions>
				<Action name="U1608575257973" action="executeview" viewname="bwf_identitygetmetadatataguid" append="false" attribute="metadatauid">
					<ViewParam name="P16085752579730" param="uid" paramvalue="{dataset.identity.get()}"/>
	...
	<Variables>
		...
		<Variable name="A1608287194199" variable="identity" displayname="identity" editortype="Ledger Identity" type="String" multivalued="false" visibility="in" notstoredvariable="true"/>
		...
		<Variable name="A1608630213295" variable="identities" displayname="identities" editortype="Default" type="String" multivalued="true" visibility="local" notstoredvariable="true"/>
	</Variables>
</Workflow>
