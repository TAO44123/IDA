...
<Workflow version="1.0">
	<Definition name="bwa_updategrouptags" statictitle="update group tags" description="update group tags" scriptfile="workflow/bw_fragments/empty.javascript" type="builtin-technical-workflow" displayname="update group tags" technical="true">
		<Component name="CSTART" type="startactivity" x="237" y="18" w="200" h="114" title="Start - bwa_updategrouptags" compact="true" outexclusive="true">
			<Ticket create="true"/>
			<Candidates name="role" role="A1608287150800"/>
			<Actions>
				<Action name="U1619455898441" action="multiclean" attribute="tags" emptyvalues="true" duplicates="true"/>
				<Action name="U1608630236771" action="empty" attribute="groups"/>
				<Action name="U1608630285096" action="multiresize" attribute="tags" attribute1="groups"/>
				<Action name="U1608630303007" action="multireplace" attribute="groups" newvalue="{dataset.uid.get()}"/>
			</Actions>
		</Component>
		<Component name="CEND" type="endactivity" x="237" y="549" w="200" h="98" title="End - bwa_updategrouptags" compact="true" inexclusive="true"/>
		...
		<Component name="C1608287218219" type="metadataactivity" x="111" y="420" w="300" h="98" title="update tags">
			<Metadata schema="bwa_grouptags" action="C">
				<Group group="groups" group1="groups"/>
		...
		<Component name="C1608575057008" type="variablechangeactivity" x="111" y="119" w="300" h="98" title="pick metadata uid">
			<Actions>
				<Action name="U1608575257973" action="executeview" viewname="bwf_groupgetmetadatataguid" append="false" attribute="metadatauid">
	...
	<Variables>
		...
		<Variable name="A1608287194199" variable="uid" displayname="uid" editortype="Ledger Group" type="String" multivalued="false" visibility="in" notstoredvariable="true"/>
		...
		<Variable name="A1608630213295" variable="groups" displayname="groups" editortype="Default" type="String" multivalued="true" visibility="local" notstoredvariable="true"/>
	</Variables>
</Workflow>
