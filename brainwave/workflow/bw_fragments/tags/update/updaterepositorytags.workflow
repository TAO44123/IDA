...
<Workflow version="1.0">
	<Definition name="bwa_updaterepositorytags" statictitle="update repository tags" description="update repository tags" scriptfile="workflow/bw_fragments/empty.javascript" type="builtin-technical-workflow" displayname="update repository tags" technical="true">
		<Component name="CSTART" type="startactivity" x="237" y="18" w="200" h="114" title="Start - bwa_updaterepositorytags" compact="true" outexclusive="true">
			<Ticket create="true"/>
			<Candidates name="role" role="A1608287150800"/>
			<Actions>
				<Action name="U1619455953559" action="multiclean" attribute="tags" emptyvalues="true" duplicates="true"/>
				<Action name="U1608630236771" action="empty" attribute="repositorys"/>
				<Action name="U1608630285096" action="multiresize" attribute="tags" attribute1="repositorys"/>
				<Action name="U1608630303007" action="multireplace" attribute="repositorys" newvalue="{dataset.uid.get()}"/>
			</Actions>
		</Component>
		<Component name="CEND" type="endactivity" x="237" y="549" w="200" h="98" title="End - bwa_updaterepositorytags" compact="true" inexclusive="true"/>
		...
		<Component name="C1608287218219" type="metadataactivity" x="111" y="420" w="300" h="98" title="update tags">
			<Metadata schema="bwa_repositorytags" action="C">
				<Repository repository="repositorys" repository1="repositorys"/>
		...
		<Component name="C1608575057008" type="variablechangeactivity" x="111" y="119" w="300" h="98" title="pick metadata uid">
			<Actions>
				<Action name="U1608575257973" action="executeview" viewname="bwf_repositorygetmetadatataguid" append="false" attribute="metadatauid">
	...
	<Variables>
		...
		<Variable name="A1608287194199" variable="uid" displayname="uid" editortype="Ledger Repository" type="String" multivalued="false" visibility="in" notstoredvariable="true"/>
		...
		<Variable name="A1608630213295" variable="repositorys" displayname="repositorys" editortype="Default" type="String" multivalued="true" visibility="local" notstoredvariable="true"/>
	</Variables>
</Workflow>
