...
<Workflow version="1.0">
	<Definition name="bwa_bulkremoveallgrouptag" statictitle="bulk remove all group tags" description="bulk remove all group tags (or a specific tag if provided)" scriptfile="workflow/bw_fragments/empty.javascript" displayname="bulk remove all group tags" type="builtin-technical-workflow" technical="true">
		<Component name="CSTART" type="startactivity" x="213" y="57" w="200" h="114" title="Start - bwa_bulkremoveallgrouptag" compact="true">
			<Ticket create="true"/>
			<Actions>
				<Action name="U1608643295900" action="executeview" viewname="bwa_groupfiltertagmetadata" append="false" attribute="metadatauids">
		...
		<Component name="CEND" type="endactivity" x="213" y="308" w="200" h="98" title="End - bwa_bulkremoveallgrouptag" compact="true"/>
		<Link name="CLINK" source="CSTART" target="C1608643312908" priority="1"/>
		<Component name="C1608643312908" type="metadataactivity" x="87" y="159" w="300" h="98" title="delete groups tags">
	...
	<Variables>
		<Variable name="A1608635809668" variable="uids" displayname="uids" editortype="Ledger Group" type="String" multivalued="true" visibility="in" notstoredvariable="true"/>
