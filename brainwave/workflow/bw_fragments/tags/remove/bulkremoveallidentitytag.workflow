...
<Workflow version="1.0">
	<Definition name="bwa_bulkremoveallidentitytag" statictitle="bulk remove all identity tags" description="bulk remove all identity tags (or a specific tag if provided)" scriptfile="workflow/bw_fragments/empty.javascript" displayname="bulk remove all identity tags" type="builtin-technical-workflow" technical="true">
		<Component name="CSTART" type="startactivity" x="213" y="57" w="200" h="114" title="Start - bwa_bulkremoveallidentitytag" compact="true">
			<Ticket create="true"/>
			<Actions>
				<Action name="U1608643295900" action="executeview" viewname="bwa_identityfiltertagmetadata" append="false" attribute="metadatauids">
		...
		<Component name="CEND" type="endactivity" x="213" y="308" w="200" h="98" title="End - bwa_bulkremoveallidentitytag" compact="true"/>
		<Link name="CLINK" source="CSTART" target="C1608643312908" priority="1"/>
		<Component name="C1608643312908" type="metadataactivity" x="87" y="159" w="300" h="98" title="delete identities tags">
	...
	<Variables>
		<Variable name="A1608635809668" variable="uids" displayname="uids" editortype="Ledger Identity" type="String" multivalued="true" visibility="in" notstoredvariable="true"/>
