...
<Workflow version="1.0">
	<Definition name="bwf_updateorganisationmetadata" statictitle="update organisation metadata" description="update organisation metadata" scriptfile="workflow/bw_fragments/empty.javascript" displayname="update organisation metadata" technical="true" type="builtin-technical-workflow">
		<Component name="CSTART" type="startactivity" x="39" y="91" w="200" h="114" title="Start - bwf_updateorganisationmetadata" compact="true">
			...
			<Actions>
				<Action name="U1607354453230" action="executeview" viewname="br_organisationDetail" append="false" attribute="organisationcode">
					<ViewParam name="P16073544532300" param="uid" paramvalue="{dataset.uid.get()}"/>
					<ViewAttribute name="P1607354453230_1" attribute="code" variable="organisationcode"/>
					<ViewAttribute name="P1607354453230_2" attribute="displayname" variable="organisationname"/>
				</Action>
				<Action name="U1607361009117" action="update" attribute="ticketdescription" newvalue="Update metadata on {dataset.organisationname.get()}"/>
			</Actions>
			<Output name="output" startdisplaynamevariable="by" ticketactionnumbervariable="ticketaction"/>
		</Component>
		<Component name="CEND" type="endactivity" x="954" y="91" w="200" h="98" title="End - bwf_updateorganisationmetadata" compact="true">
			<Actions>
		...
		<Component name="C1607354546295" type="metadataactivity" x="575" y="66" w="300" h="98" title="organisation description">
			<Metadata action="C" schema="bwa_organisationmetadata">
				<ValueOrganisation/>
				<Organisation organisation="uid" organisation1="uid"/>
				<Data string4="description" string5="sensitivityreason" integer1="sensitivitylevel"/>
			</Metadata>
		</Component>
		...
		<Component name="C1607360523176" type="ticketreviewactivity" x="169" y="66" w="300" h="98" title="write the ticket">
			<TicketReview ticketaction="ticketaction">
				...
				<Organisation organisationvariable="uid"/>
			</TicketReview>
		</Component>
	...
	<Variables>
		...
		<Variable name="A1607354048954" variable="uid" displayname="uid" editortype="Ledger Organisation" type="String" multivalued="false" visibility="in" description="organisation uid to update" notstoredvariable="false"/>
		<Variable name="A1607354067896" variable="organisationcode" displayname="organisation code" editortype="Default" type="String" multivalued="false" visibility="local" description="organisation code" notstoredvariable="false"/>
		<Variable name="A1607354080954" variable="organisationname" displayname="organisation name" editortype="Default" type="String" multivalued="false" visibility="local" description="organisation name" notstoredvariable="false"/>
