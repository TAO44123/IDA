...
<Workflow version="1.0">
	<Definition name="bwa_markLatestRightReviewApplicationStatus" statictitle="markLatestAccountReviewRepositoryStatus" description="attach a metadata to the repositories which have been reviewed at least once" scriptfile="/workflow/bw_access360/markLatestAccountReviewRepositoryStatus.javascript" technical="true" type="builtin-technical-workflow">
		<Component name="CSTART" type="startactivity" x="163" y="52" w="200" h="114" title="Start" compact="true">
			...
			<Actions>
				<Action name="U1666541079176" action="executeview" viewname="bwiasr_listlatestcompletedcampaigns" append="false" attribute="latestcampaignrecorduids">
					...
					<ViewParam name="P16665410791761" param="reviewtype" paramvalue="right"/>
					<ViewAttribute name="P1666541079176_2" attribute="recorduid" variable="latestcampaignrecorduids"/>
				</Action>
				<Action name="U1666521699225" action="executeview" viewname="bwiar_listlatestcampaignperapplication" append="false" attribute="closedate">
					...
					<ViewAttribute name="P1666521699225_7" attribute="uid" variable="applicationuid"/>
				</Action>
			</Actions>
		</Component>
		...
		<Component name="C1666521715675" type="metadataactivity" x="37" y="173" w="300" h="98" title="application right review metadata">
			<Metadata action="C" schema="bwr_applicationrightreviewstatus">
				...
				<Application application="applicationuid"/>
			</Metadata>
		</Component>
	...
	<Variables>
		...
		<Variable name="A1666541146407" variable="applicationuid" displayname="applicationuid" editortype="Ledger Application" type="String" multivalued="true" visibility="local" notstoredvariable="true"/>
	</Variables>
	<Roles>
