...
//Get all profiles info from the raw "JSON" string
function get_access_profiles(){
	var /* String */ roles_id = dataset.id;
	var /* String */ raw_accessprofiles = dataset.accessprofiles;
	
	var /* Array */ accessprofile_id = new Array();
	var /* Array */ accessprofile_name = new Array();
	var /* Array */ accessprofile_type = new Array();

	var /* Array */ json_accessprofiles = JSON.parse(raw_accessprofiles);
	
	json_accessprofiles.forEach(function(json_obj){
		accessprofile_id.push(json_obj.id);
		accessprofile_name.push(json_obj.name);
		accessprofile_type.push(json_obj.type);
	});
	print('extracted from json array : ' + accessprofile_id + ' , ' + accessprofile_name + ' , ' + accessprofile_type)
	// AddAttributeWithValue( /*DataSet*/ ds, /*String*/ attributeName, /*String*/ attributeType, /*Boolean*/ multivalued, value )
	AddAttributeWithValues( /*DataSet*/ dataset, /*String*/ "accessprofile_id", /*String*/ "String", /*Boolean*/ true, accessprofile_id )
	AddAttributeWithValues( /*DataSet*/ dataset, /*String*/ "accessprofile_name", /*String*/ "String", /*Boolean*/ true, accessprofile_name )
	AddAttributeWithValues( /*DataSet*/ dataset, /*String*/ "accessprofile_type", /*String*/ "String", /*Boolean*/ true, accessprofile_type )
}
