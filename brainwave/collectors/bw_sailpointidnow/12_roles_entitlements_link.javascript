...
//Get all entitlements info from the raw "JSON" string
function get_entitlements(){
	var /* String */ roles_id = dataset.id;
	var /* String */ raw_entitlements = dataset.entitlements;
	
	var /* Array */ entitlements_id = new Array();
	var /* Array */ entitlements_name = new Array();
	var /* Array */ entitlements_type = new Array();

	var /* Array */ json_entitlements = JSON.parse(raw_entitlements);
	
	json_entitlements.forEach(function(json_obj){
		entitlements_id.push(json_obj.id);
		entitlements_name.push(json_obj.name);
		entitlements_type.push(json_obj.type);
	});
	print('extracted from json array : ' + entitlements_id + ' , ' + entitlements_name + ' , ' + entitlements_type)
	// AddAttributeWithValue( /*DataSet*/ ds, /*String*/ attributeName, /*String*/ attributeType, /*Boolean*/ multivalued, value )
	AddAttributeWithValues( /*DataSet*/ dataset, /*String*/ "entitlements_id", /*String*/ "String", /*Boolean*/ true, entitlements_id )
	AddAttributeWithValues( /*DataSet*/ dataset, /*String*/ "entitlements_name", /*String*/ "String", /*Boolean*/ true, entitlements_name )
	AddAttributeWithValues( /*DataSet*/ dataset, /*String*/ "entitlements_type", /*String*/ "String", /*Boolean*/ true, entitlements_type )
}
