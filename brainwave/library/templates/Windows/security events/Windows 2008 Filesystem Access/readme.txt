Extracting Filesystem access Security Events logs on Windows Server 
...
psloglist.exe -d 90 -s -r -i 4656 Security >security_events.csv
...
psloglist.exe @servers.txt -d 90 -s -r -i 4656 Security >security_events.csv
